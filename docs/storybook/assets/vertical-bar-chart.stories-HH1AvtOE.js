import{j as e,r as w}from"./iframe-C3tcij1x.js";import{aZ as K,a_ as B,u as A,bx as _,C as k,b as q,by as j,c as F,bz as V,bA as L,a as z,d as R,e as b}from"./chart-palette-preview-C6AuSo_R.js";import{c as S,B as T,C as P,a as E,b as G}from"./bar-rectangle-1t_OXxFd.js";import{C as p,a as y,b as h,d as x}from"./card-B0zfQcea.js";import{a as M}from"./story-section-B3q-8Mn1.js";import{n as H,o as D}from"./data-CGl4bGS9.js";function N({id:a,dataKey:n,layout:l,patternIndex:d,color:u,onClick:t}){return e.jsx(S,{dataKey:n,fill:u,onClick:t,shape:s=>e.jsx(B,{...s,fill:`url(#${a}-bar-pattern-${d})`,style:t?{cursor:"pointer"}:void 0}),radius:2,children:e.jsx(K,{dataKey:n,className:"fill-foreground",fontSize:12,position:l=="horizontal"?"top":"middle",style:t?{cursor:"pointer"}:void 0})})}N.__docgenInfo={description:`Bar + Label
