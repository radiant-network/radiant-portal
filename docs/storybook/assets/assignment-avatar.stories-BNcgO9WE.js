import{j as s}from"./iframe-DY5-UQdi.js";import{A as e}from"./avatar-BKqsl5kv.js";import{a as l,b as p,S as u}from"./story-section-BfGxLv6g.js";import{a as g}from"./utils-BQbZHAUO.js";import"./preload-helper-PPVm8Dsz.js";import"./avatar-DQwZdOL_.js";import"./avatar.utils-C1EeCBXD.js";import"./avatar.styles-BfI55aWd.js";import"./user-DicrVcQZ.js";import"./user-avatar-ix4koLGU.js";import"./hover-card-6RmrH9Mr.js";import"./anchor-link-wD32XCkd.js";const z={title:"Components/Avatars/Assignment Avatar",component:e,argTypes:{size:{control:{type:"select"},options:g},maxAvatars:{control:{type:"number",min:1}}}},a=[{id:"user-1",name:"Jean-François Soucy",email:"jeanfrancois.soucy.med@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-2",name:"Julie M. Gauthier",email:"julie.m.gauthier.hsj@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-3",name:"Jacques Michaud",email:"jacques.michaud.med@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-4",name:"Sarah Wilson",email:"sarah.wilson@hospital.ca",organization:"Toronto General"},{id:"user-5",name:"David Brown",email:"david.brown@clinic.ca",organization:"Vancouver Clinic"},{id:"user-6",name:"Lisa Garcia",email:"lisa.garcia@medical.ca",organization:"Calgary Medical"}],i={render:()=>{const n=[{label:"Assignment Button",users:[],canAssign:!0},{label:"User Avatar",users:[a[0]]},{label:"Users without count",users:[a[0],a[1]]},{label:"Users with count",users:a.slice(0,4)}];return s.jsx(u,{children:n.map(t=>s.jsx(l,{title:t.label,children:s.jsx("div",{className:"flex items-end gap-6",children:g.map(r=>s.jsxs("div",{className:"flex flex-col items-center gap-2",children:[s.jsx(e,{users:t.users,size:r,canAssign:t.canAssign}),s.jsx("span",{className:"text-xs text-muted-foreground",children:r})]},r))})},t.label))})}},c={render:()=>{const n=[2,3,4],t=[1,2,3,5];return s.jsx(u,{children:n.map(r=>s.jsx(l,{title:`maxAvatars = ${r}`,children:s.jsx("div",{className:"flex items-center gap-6",children:t.map(x=>s.jsxs("div",{className:"flex flex-col items-center gap-2",children:[s.jsx(e,{users:a.slice(0,x),maxAvatars:r}),s.jsxs("span",{className:"text-xs text-muted-foreground",children:[x," users"]})]},x))})},r))})}},o={render:()=>{const n=[{user:{id:"i1",name:"Lisa Garcia"},note:"First + last → LG"},{user:{id:"i2",name:"Jean-François Soucy"},note:"Hyphenated first → JS"},{user:{id:"i3",name:"Anne Marie Tremblay"},note:"Only first two words → AM"},{user:{id:"i4",name:"Madonna"},note:"Single word → MA"},{user:{id:"i5",name:"Alex Bernard",initials:"XYZ"},note:"Custom initials → XY"}];return s.jsx(l,{title:"Initials",children:s.jsx("div",{className:"flex items-start gap-6",children:n.map(({user:t,note:r})=>s.jsxs("div",{className:"flex w-32 flex-col items-center gap-2 text-center",children:[s.jsx(e,{users:[t]}),s.jsx("span",{className:"text-xs font-medium",children:t.name}),s.jsx("span",{className:"text-xs text-muted-foreground",children:r})]},t.id))})})}},d={render:()=>s.jsx(l,{title:"Assignment Interactions",description:"Hover over the avatars to see tooltips and user details popover.",children:s.jsxs("div",{className:"grid grid-cols-2 gap-6",children:[s.jsxs("div",{className:"space-y-2",children:[s.jsx(p,{children:"Unassigned States"}),s.jsxs("div",{className:"flex items-center gap-4",children:[s.jsxs("div",{className:"flex flex-col items-center gap-2",children:[s.jsx(e,{users:[],canAssign:!0,onAssignClick:()=>alert("Assign clicked!")}),s.jsx("span",{className:"text-xs text-muted-foreground",children:"Can Assign"})]}),s.jsxs("div",{className:"flex flex-col items-center gap-2",children:[s.jsx(e,{users:[],canAssign:!1}),s.jsx("span",{className:"text-xs text-muted-foreground",children:"Cannot Assign"})]})]})]}),s.jsxs("div",{className:"space-y-2",children:[s.jsx(p,{children:"Assigned States (Hover for Details)"}),s.jsxs("div",{className:"flex items-center gap-4",children:[s.jsxs("div",{className:"flex flex-col items-center gap-2",children:[s.jsx(e,{users:[a[0]],size:"md"}),s.jsx("span",{className:"text-xs text-muted-foreground",children:"Single User"})]}),s.jsxs("div",{className:"flex flex-col items-center gap-2",children:[s.jsx(e,{users:[a[0],a[1]],size:"md"}),s.jsx("span",{className:"text-xs text-muted-foreground",children:"Two Users"})]}),s.jsxs("div",{className:"flex flex-col items-center gap-2",children:[s.jsx(e,{users:a.slice(0,4),size:"md"}),s.jsx("span",{className:"text-xs text-muted-foreground",children:"Multiple Users"})]})]})]})]})})},m={render:()=>s.jsx(l,{title:"Table Cell Usage Example",description:"Hover over avatars to see assignment tooltips and user details.",children:s.jsx("div",{className:"w-full rounded-lg border",children:s.jsxs("table",{className:"w-full",children:[s.jsx("thead",{children:s.jsxs("tr",{className:"border-b bg-muted/50",children:[s.jsx("th",{className:"text-left p-3",children:"Case ID"}),s.jsx("th",{className:"text-left p-3",children:"Assigned Users"}),s.jsx("th",{className:"text-left p-3",children:"Status"})]})}),s.jsxs("tbody",{children:[s.jsxs("tr",{className:"border-b",children:[s.jsx("td",{className:"p-3 font-mono text-sm",children:"666106"}),s.jsx("td",{className:"p-3",children:s.jsx(e,{users:[],canAssign:!0,onAssignClick:()=>alert("Assign to case 666106")})}),s.jsx("td",{className:"p-3",children:s.jsx("span",{className:"text-muted-foreground",children:"Can Assign"})})]}),s.jsxs("tr",{className:"border-b",children:[s.jsx("td",{className:"p-3 font-mono text-sm",children:"658344"}),s.jsx("td",{className:"p-3",children:s.jsx(e,{users:[],canAssign:!1})}),s.jsx("td",{className:"p-3",children:s.jsx("span",{className:"text-muted-foreground",children:"No Assignment"})})]}),s.jsxs("tr",{className:"border-b",children:[s.jsx("td",{className:"p-3 font-mono text-sm",children:"658142"}),s.jsx("td",{className:"p-3",children:s.jsx(e,{users:[a[0]]})}),s.jsx("td",{className:"p-3",children:s.jsx("span",{className:"text-green-600",children:"Assigned"})})]}),s.jsxs("tr",{className:"border-b",children:[s.jsx("td",{className:"p-3 font-mono text-sm",children:"658286"}),s.jsx("td",{className:"p-3",children:s.jsx(e,{users:[a[1],a[2]]})}),s.jsx("td",{className:"p-3",children:s.jsx("span",{className:"text-blue-600",children:"Collaborative"})})]}),s.jsxs("tr",{children:[s.jsx("td",{className:"p-3 font-mono text-sm",children:"658290"}),s.jsx("td",{className:"p-3",children:s.jsx(e,{users:a.slice(0,4)})}),s.jsx("td",{className:"p-3",children:s.jsx("span",{className:"text-purple-600",children:"Team Assignment"})})]})]})]})})})};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => {
    const states: {
      label: string;
      users: AvatarUser[];
...
}`,...m.parameters?.docs?.source}}};const M=["Sizes","MaxAvatars","Initials","AssignmentStates","TableUsageExample"];export{d as AssignmentStates,o as Initials,c as MaxAvatars,i as Sizes,m as TableUsageExample,M as __namedExportsOrder,z as default};
