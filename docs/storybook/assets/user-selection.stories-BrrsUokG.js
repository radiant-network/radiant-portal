import{j as e,r as i}from"./iframe-Dazgu-xC.js";import{U as n,R as t,a as Y}from"./table-header-user-filter-B56-UN78.js";import"./preload-helper-Dp1pzeXC.js";import"./button-8J658wd4.js";import"./index-Aj7YrDzF.js";import"./action-button-BfMVkXo8.js";import"./dropdown-menu-CUwMNzYL.js";import"./index-DQ2PnqWf.js";import"./index-6Lx37dYF.js";import"./check-CzryUxBS.js";import"./circle-CZgbCMc1.js";import"./separator-uwq_OMO5.js";import"./i18n-CWqrHIWh.js";import"./popover-BjOmwFyM.js";import"./avatar-hTWwQgoP.js";import"./index-B3HPNJL0.js";import"./avatar.utils-CC8GqUxo.js";import"./constants-DFO-ev5B.js";import"./user-CmX3iciL.js";import"./x-CKsu-GPn.js";import"./checkbox-DwIg2Wk7.js";import"./index-CwEq_5Lw.js";const Re={title:"Assignation/UserSelection",component:n,args:{availableUsers:[],selectedUsers:[],onUsersChange:()=>{}},parameters:{layout:"padded"}},a=[{id:"user-1",name:"Jean-François Soucy",email:"jeanfrancois.soucy.med@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-2",name:"Julie M. Gauthier",email:"julie.m.gauthier.hsj@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-3",name:"Jacques Michaud",email:"jacques.michaud.med@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-4",name:"Fadi Hamdan",email:"fadi.hamdan@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-5",name:"Catalina Maftei",email:"catalina.maftei@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-6",name:"Sarah Wilson",email:"sarah.wilson@hospital.ca",organization:"Toronto General"},{id:"user-7",name:"David Brown",email:"david.brown@clinic.ca",organization:"Vancouver Clinic"}],Z=()=>{const[s,r]=i.useState([]);return e.jsx("div",{className:"max-w-lg",children:e.jsx(n,{availableUsers:a,selectedUsers:s,onUsersChange:r})})},l={render:()=>e.jsx(Z,{})},ee=()=>{const[s,r]=i.useState([a[0]]);return e.jsx("div",{className:"max-w-lg",children:e.jsx(n,{availableUsers:a,selectedUsers:s,onUsersChange:r})})},o={render:()=>e.jsx(ee,{})},se=()=>{const[s,r]=i.useState([a[0],a[1],a[2]]);return e.jsx("div",{className:"max-w-lg",children:e.jsx(n,{availableUsers:a,selectedUsers:s,onUsersChange:r})})},c={render:()=>e.jsx(se,{})},ae=()=>{const[s,r]=i.useState([]);return e.jsxs("div",{className:"max-w-2xl space-y-6",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-semibold mb-4",children:"User Selection Popover"}),e.jsx(Y,{availableUsers:a,selectedUsers:s,onUsersChange:r,triggerText:"Assignation"})]}),e.jsxs("div",{className:"p-4 bg-gray-50 rounded-lg",children:[e.jsx("h4",{className:"font-medium mb-2",children:"État actuel:"}),e.jsx("p",{className:"text-sm text-gray-600",children:s.length===0?"Aucun utilisateur sélectionné":`${s.length} utilisateur(s) sélectionné(s): ${s.map(v=>v.name).join(", ")}`})]})]})},d={render:()=>e.jsx(ae,{})},re=()=>{const[s,r]=i.useState([]);return e.jsxs("div",{className:"max-w-2xl space-y-6",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-semibold mb-4",children:"User Selection Demo"}),e.jsx(n,{availableUsers:a,selectedUsers:s,onUsersChange:r})]}),e.jsxs("div",{className:"p-4 bg-gray-50 rounded-lg",children:[e.jsx("h4",{className:"font-medium mb-2",children:"État actuel:"}),e.jsx("p",{className:"text-sm text-gray-600",children:s.length===0?"Aucun utilisateur sélectionné":`${s.length} utilisateur(s) sélectionné(s): ${s.map(v=>v.name).join(", ")}`})]})]})},m={render:()=>e.jsx(re,{})},p={render:()=>e.jsxs("div",{className:"max-w-lg space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Read-Only User Selection (Empty)"}),e.jsx(t,{selectedUsers:[]}),e.jsx("p",{className:"text-sm text-gray-600",children:"Note: Component returns null when no users are selected"})]})},g={render:()=>e.jsxs("div",{className:"max-w-lg space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Read-Only User Selection (Single User)"}),e.jsx(t,{selectedUsers:[a[0]]}),e.jsxs("div",{className:"text-sm text-gray-600",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Selected:"})," ",a[0].name]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Organization:"})," ",a[0].organization]})]})]})},x={render:()=>e.jsxs("div",{className:"max-w-lg space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Read-Only User Selection (Multiple Users)"}),e.jsx(t,{selectedUsers:[a[0],a[1],a[2]]}),e.jsxs("div",{className:"text-sm text-gray-600",children:[e.jsx("p",{children:e.jsx("strong",{children:"Selected Users:"})}),e.jsx("ul",{className:"list-disc list-inside ml-2",children:[a[0],a[1],a[2]].map(s=>e.jsxs("li",{children:[s.name," (",s.organization,")"]},s.id))})]})]})},u={render:()=>{const s={id:"not-assign",name:"Not assigned",organization:""};return e.jsxs("div",{className:"max-w-lg space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Read-Only User Selection (Not Assigned)"}),e.jsx(t,{selectedUsers:[s]}),e.jsxs("div",{className:"text-sm text-gray-600",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Status:"})," No assignment"]}),e.jsx("p",{children:"Shows the unassigned state with the user icon"})]})]})}},h={render:()=>{const s={id:"not-assign",name:"Not assigned",organization:""};return e.jsxs("div",{className:"max-w-lg space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Read-Only User Selection (Mixed)"}),e.jsx(t,{selectedUsers:[a[0],s,a[2]]}),e.jsxs("div",{className:"text-sm text-gray-600",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Note:"})," Shows mix of assigned users and unassigned state"]}),e.jsx("p",{children:"Demonstrates the different avatar styles in read-only mode"})]})]})}},U={render:()=>{const s=[a[0],a[1]];return e.jsxs("div",{className:"max-w-2xl space-y-6",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Editable vs Read-Only Comparison"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-2",children:"Read-Only Version:"}),e.jsx(t,{selectedUsers:s}),e.jsx("p",{className:"text-sm text-gray-500 mt-1",children:"No interaction possible - display only"})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-2",children:"Editable Version:"}),e.jsx(n,{availableUsers:a,selectedUsers:s,onUsersChange:()=>{}}),e.jsx("p",{className:"text-sm text-gray-500 mt-1",children:"Interactive - allows searching and removing users"})]})]})]})}};var y,j,N;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => <DefaultComponent />
}`,...(N=(j=l.parameters)==null?void 0:j.docs)==null?void 0:N.source}}};var S,b,f;o.parameters={...o.parameters,docs:{...(S=o.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => <WithPreselectedUsersComponent />
}`,...(f=(b=o.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var O,R,C;c.parameters={...c.parameters,docs:{...(O=c.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => <WithMultiplePreselectedUsersComponent />
}`,...(C=(R=c.parameters)==null?void 0:R.docs)==null?void 0:C.source}}};var w,M,z;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`{
...
}`,...(V=(W=p.parameters)==null?void 0:W.docs)==null?void 0:V.source}}};var J,q,H;g.parameters={...g.parameters,docs:{...(J=g.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => <div className="max-w-lg space-y-4">
...
}`,...(H=(q=g.parameters)==null?void 0:q.docs)==null?void 0:H.source}}};var I,L,$;x.parameters={...x.parameters,docs:{...(I=x.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: () => <div className="max-w-lg space-y-4">
...
}`,...($=(L=x.parameters)==null?void 0:L.docs)==null?void 0:$.source}}};var F,G,T;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => {
