import{r as v,j as e}from"./iframe-C6MOWQMA.js";import{u as j,a as w,C as N,b as P,c as T,d as k,e as m}from"./chart-palette-preview-2KGKXW45.js";import{B as H,C as D,a as B,b as M}from"./bar-rectangle-B8HpC_zB.js";import{C as r,a as n,b as s,d as i}from"./card-BrEhw1co.js";import{a as K}from"./story-section-_wEsjD86.js";import{h as _,m as I,f as q,g as O}from"./data-CGl4bGS9.js";function t({axis:a,data:C,colorblindMode:y=!0,onClick:h,tooltip:f}){const u=v.useId(),x=j(C),g=w(a);return e.jsx(N,{config:g,children:e.jsxs(H,{accessibilityLayer:!0,data:x,layout:"vertical",margin:{bottom:12,left:6},children:[e.jsx(P,{id:u,data:x,colorblindMode:y}),e.jsx(D,{}),e.jsx(B,{axis:a,layout:"vertical"}),e.jsx(M,{dataKey:"count",id:u,layout:"vertical",onClick:h}),e.jsx(T,{isAnimationActive:!1,content:e.jsx(k,{hideLabel:!0,formatter:(F,A,L,R,b)=>f(b)})})]})})}t.__docgenInfo={description:`Horizontal bar chart with a single series, one bar per category.
