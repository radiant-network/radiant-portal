import{u as d,j as t,r as g,B as h}from"./iframe-CaCkF73x.js";import{R as r}from"./rich-text-editor-VhD60Rtj.js";import{R as x}from"./rich-text-viewer-BKjspsjM.js";import{a as u}from"./story-section-BzjNo_xI.js";import{S}from"./story-error-field-CY0o5CSr.js";import"./preload-helper-PPVm8Dsz.js";import"./with-selector-BIcfjmYR.js";import"./toggle-Bee5q-3T.js";import"./popover-C9836Iqo.js";import"./input-BlGgpyCQ.js";import"./label-DBt1t2N1.js";import"./x-M9Dp6o6f.js";import"./trash-Ckn1HOll.js";import"./underline-B66IwYNr.js";import"./index-CX1GHf_h.js";const{fn:f}=__STORYBOOK_MODULE_TEST__,{action:a}=__STORYBOOK_MODULE_ACTIONS__,D={title:"Components/Inputs/Rich Text Editor",component:r,args:{value:"<h3>Hello</h3>",onChange:f(),placeholder:"Placeholder"}},n={render:o=>{const{t:e}=d();return t.jsx(u,{title:"Default",children:t.jsx(r,{value:o.value,onChange:a("onChange"),onBlur:a("onBlur"),placeholder:e("common.editor.placeholder"),wrapperClassName:"min-w-[500px]",autoFocus:!0})})}},s={render:o=>{const{t:e}=d();return t.jsx(u,{title:"With actions",children:t.jsx(r,{value:o.value,onChange:a("onChange"),onBlur:a("onBlur"),placeholder:e("common.editor.placeholder"),wrapperClassName:"min-w-[500px]",autoFocus:!0,actions:[t.jsx(h,{variant:"outline",size:"2xs",children:e("common.cancel")},"cancel"),t.jsx(h,{size:"2xs",children:e("common.save")},"save")]})})}},l={args:{value:'<p dir="auto" style="text-align: left"><strong>Rich Text Editor</strong></p><p dir="auto" style="text-align: left">A modern WYSIWYG rich text editor based on <a target="_blank" rel="noopener noreferrer nofollow" class="link" href="https://github.com/scrumpy/tiptap">tiptap</a> and <a target="_blank" rel="noopener noreferrer nofollow" class="link" href="https://ui.shadcn.com/">shadcn</a> for Reactjs</p><p dir="auto"></p><p dir="auto"><strong>Features</strong></p><ul dir="auto"><li dir="auto"><p dir="auto">Use React, tailwindcss, <a target="_blank" rel="noopener noreferrer nofollow" class="link" href="https://ui.shadcn.com/">shadcn</a> components</p></li><li dir="auto"><p dir="auto">I18n support (vi, en, zh, pt, ...)</p></li><li dir="auto"><p dir="auto">Slash Commands (type <code>/</code> to show menu list)</p></li><li dir="auto"><p dir="auto">Multi Column</p></li><li dir="auto"><p dir="auto">Support emoji <span dir="auto" data-name="100" data-type="emoji">💯</span> (type <code>:</code> to show emoji list)</p></li><li dir="auto"><p dir="auto">Support iframe</p></li><li dir="auto"><p dir="auto">Support mermaid</p></li><li dir="auto"><p dir="auto">Support mention <span class="mention" data-type="mention" dir="auto" data-id="0" data-label="hunghg255" data-mention-suggestion-char="@">@hunghg255</span> (type <code>@</code> to show list)</p></li><li dir="auto"><p dir="auto">Suport katex math (<span class="katex" dir="auto" text="c%20%3D%20%5Cpm%5Csqrt%7Ba%5E2%20%2B%20b%5E2%7D" macros=""></span>)</p></li></ul><p dir="auto"></p>'},render:o=>{const[e,c]=g.useState(o.value??"");return t.jsx(u,{title:"Viewer",children:t.jsxs("div",{className:"flex w-full gap-6",children:[t.jsx(r,{className:"w-[800px]",value:e,onChange:i=>c(i)}),t.jsx(x,{value:e,wrapperClassName:"max-w-[800px]",autoFocus:!0})]})})}},p={render:()=>{const{t:o}=d(),[e,c]=g.useState(""),i=e.replace(/<[^>]*>/g,"").replaceAll("&nbsp;","").trim()==="";return t.jsx(u,{title:"Error",children:t.jsx(S,{label:"Note",width:500,invalid:i,children:t.jsx(r,{"aria-invalid":i,value:"",onChange:m=>{c(m),a("onChange")(m)},onBlur:a("onBlur"),placeholder:o("common.editor.placeholder")})})})}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      t
    } = useI18n();
...
}`,...p.parameters?.docs?.source}}};const I=["Default","WithActions","Viewer","ErrorState"];export{n as Default,p as ErrorState,l as Viewer,s as WithActions,I as __namedExportsOrder,D as default};
