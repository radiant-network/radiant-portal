import{j as o}from"./iframe-yUfF9TIc.js";import{A as c}from"./action-button-_1mg2YCc.js";import{b as m,a as p}from"./utils-C8QHPIem.js";import"./preload-helper-Dp1pzeXC.js";import"./dropdown-menu-jyCWUAQn.js";import"./index-B00Ep4-c.js";import"./circle-DfDoC5sj.js";import"./check-CIqPLRIg.js";import"./separator-B6T5EJNA.js";import"./index-Cz7BRqZL.js";const{fn:i}=__STORYBOOK_MODULE_TEST__,C={title:"Buttons/Action Button",component:c,args:{onClick:i(),size:"default",disabled:!1,actions:[],onDefaultAction:i()}},a={args:{children:"Button",actions:[{label:"action 1",onClick:()=>{}},{label:"action 2",onClick:()=>{}},{label:"action 3",onClick:()=>{}}]},render:l=>o.jsx("div",{className:"flex flex-col gap-6",children:m.map(n=>o.jsx("div",{className:"flex gap-2",children:p.map(t=>o.jsxs(c,{...l,variant:n,size:t,children:[n,"-",t]},`${n}-${t}`))},n))})};var e,s,r;a.parameters={...a.parameters,docs:{...(e=a.parameters)==null?void 0:e.docs,source:{originalSource:`{
  args: {
    children: 'Button',
    actions: [{
      label: 'action 1',
