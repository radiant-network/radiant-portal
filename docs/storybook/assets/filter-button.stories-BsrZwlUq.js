import{a as w,j as e,r as L}from"./iframe-CgZaKe5d.js";import{F as O}from"./filter-button-DcGd-3gK.js";import{P as K}from"./priority-indicator-__j1Fy_b.js";import{a as t,S as P}from"./story-section-Cd-IQlgl.js";import{F as v}from"./file-text-DeA8BOpT.js";import{C as F}from"./calendar-DH3Ud_ez.js";import{U as n}from"./users-ChEQ132C.js";import{S as g}from"./settings-CJ6rgyvL.js";import"./preload-helper-PPVm8Dsz.js";import"./checkbox-filter-DAe_Avh7.js";import"./checkbox-DcjH3Pt0.js";import"./index-BTySKr1x.js";import"./label-C-mLdX7m.js";import"./number-format-gi98STWl.js";import"./badge-Dyg9dEFi.js";import"./x-C9LJTscZ.js";import"./command-BaJw4-51.js";import"./dialog-P8uD31mQ.js";import"./popover-DDZSXOOd.js";import"./search-omVJqrmb.js";import"./indicator-DXAhJ-Oz.js";import"./shape-triangle-up-icon-BccBKwJ5.js";const W=[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]],k=w("database",W);const M=[["path",{d:"M10 20a1 1 0 0 0 .553.895l2 1A1 1 0 0 0 14 21v-7a2 2 0 0 1 .517-1.341L21.74 4.67A1 1 0 0 0 21 3H3a1 1 0 0 0-.742 1.67l7.225 7.989A2 2 0 0 1 10 14z",key:"sc7q7i"}]],i=w("funnel",M),ae={title:"Components/Buttons/Filter Button",component:O,args:{label:"Filter",selected:[],options:[],onSelect:()=>{}}},r=[{key:"option1",label:"Option 1",count:42},{key:"option2",label:"Option 2",count:28},{key:"option3",label:"Option 3",count:15},{key:"option4",label:"Option 4",count:7},{key:"option5",label:"Option 5",count:3}],N=[{key:"cardiovascular_disease",label:"Cardiovascular Disease and Related Conditions Including Hypertension",tooltip:"This includes all forms of cardiovascular disease including coronary artery disease, heart failure, arrhythmias, and hypertension-related conditions.",count:156,icon:n},{key:"diabetes_complications",label:"Diabetes Mellitus Type 2 with Complications and Comorbidities",tooltip:"Type 2 diabetes with various complications such as diabetic nephropathy, retinopathy, neuropathy, and associated cardiovascular risks.",count:89,icon:k},{key:"respiratory_conditions",label:"Chronic Respiratory Conditions Including COPD and Asthma",tooltip:"Chronic obstructive pulmonary disease, asthma, and other long-term respiratory conditions requiring ongoing management.",count:67,icon:v},{key:"neurological_disorders",label:"Neurological Disorders and Neurodegenerative Conditions",tooltip:"Includes Alzheimer's disease, Parkinson's disease, multiple sclerosis, and other neurological conditions.",count:34,icon:g}],C=[{key:"users",label:"Users",count:42,icon:n},{key:"database",label:"Database",count:28,icon:k},{key:"files",label:"Files",count:15,icon:v},{key:"calendar",label:"Calendar",count:7,icon:F}],I=[{key:"option1",label:"Option 1"},{key:"option2",label:"Option 2"},{key:"option3",label:"Option 3"}],A=["routine","urgent","asap","stat"].map((s,a)=>({key:s,label:e.jsx(K,{size:"sm",code:s}),count:[42,28,15,7][a]})),z=[{key:"EXTUM",label:"Tumoral Analysis",tooltip:"External Tumoral Analysis",count:234},{key:"CHUSJ",label:"CHU Sainte-Justine Laboratory",count:156},{key:"LSPQ",label:"Laboratoire de santé publique du Québec",count:89},{key:"MUHC",label:"McGill University Health Centre",count:42}],T=[{key:"download",label:"Download Report",icon:v},{key:"export",label:"Export Data",icon:k},{key:"schedule",label:"Schedule Analysis",icon:F},{key:"share",label:"Share Results",icon:n}],o=({initialSelected:s=[],...a})=>{const[B,f]=L.useState(s);return e.jsx(O,{...a,selected:B,onSelect:f})},l={render:()=>e.jsx(t,{title:"Popover sizes",children:e.jsx("div",{className:"flex gap-2",children:["xs","sm","md","lg"].map(s=>e.jsx(O,{popoverSize:s,label:`size ${s}`,options:r,selected:[],onSelect:function(a){throw new Error("Function not implemented.")}},s))})})},c={render:()=>e.jsx(t,{title:"Basic filter with checkboxes",children:e.jsx(o,{label:"Status",options:r,placeholder:"Search status...",icon:e.jsx(i,{className:"size-4"})})})},p={render:()=>e.jsx(t,{title:"Long text with tooltips",children:e.jsx(o,{label:"Medical Conditions",options:N,placeholder:"Search conditions...",withTooltip:!0,icon:e.jsx(n,{className:"size-4"})})})},d={render:()=>e.jsx(t,{title:"Checkbox list with per-item icons",children:e.jsx(o,{label:"Type",options:C,placeholder:"Search type...",icon:e.jsx(i,{className:"size-4"})})})},h={render:()=>e.jsx(t,{title:"Options without counts",children:e.jsx(o,{label:"Status",options:I,placeholder:"Search status...",icon:e.jsx(i,{className:"size-4"})})})},u={render:()=>e.jsx(t,{title:"React node labels (PriorityIndicator)",children:e.jsx(o,{label:"Priority",options:A,placeholder:"Search priority...",icon:e.jsx(i,{className:"size-4"})})})},S={render:()=>e.jsx(t,{title:"Key display only (no tooltip)",children:e.jsx(o,{label:"Lab",options:z,popoverSize:"md",placeholder:"Search lab...",showKey:!0,icon:e.jsx(i,{className:"size-4"})})})},m={render:()=>e.jsx(t,{title:"Key display + tooltip (code-based filter)",children:e.jsx(o,{label:"Lab",options:z,popoverSize:"lg",placeholder:"Search lab...",showKey:!0,withTooltip:!0,icon:e.jsx(i,{className:"size-4"})})})},y={render:()=>e.jsx(t,{title:"Action mode (no checkboxes)",children:e.jsx(o,{label:"Actions",options:T,actionMode:!0,closeOnSelect:!0,placeholder:"Search actions...",icon:e.jsx(g,{className:"size-4"})})})},b={render:()=>e.jsx(t,{title:"With preselected items",children:e.jsx(o,{label:"Status",options:r,initialSelected:["option1","option3"],placeholder:"Search status...",icon:e.jsx(i,{className:"size-4"})})})},x={render:()=>e.jsx(t,{title:"Open on appear",children:e.jsx(o,{label:"Auto Open",options:r,isOpen:!0,placeholder:"Search...",icon:e.jsx(i,{className:"size-4"})})})},j={render:()=>e.jsxs(P,{children:[e.jsx(t,{title:"Basic filter with checkboxes",children:e.jsx(o,{label:"Status",options:r,placeholder:"Search status...",icon:e.jsx(i,{className:"size-4"})})}),e.jsx(t,{title:"Long text with tooltips",children:e.jsx(o,{label:"Medical Conditions",options:N,placeholder:"Search conditions...",withTooltip:!0,icon:e.jsx(n,{className:"size-4"})})}),e.jsx(t,{title:"Key display only (no tooltip)",children:e.jsx(o,{label:"Lab",options:z,popoverSize:"md",placeholder:"Search lab...",showKey:!0,icon:e.jsx(i,{className:"size-4"})})}),e.jsx(t,{title:"Key display + tooltip (code-based filter)",children:e.jsx(o,{label:"Lab",options:z,popoverSize:"lg",placeholder:"Search lab...",showKey:!0,withTooltip:!0,icon:e.jsx(i,{className:"size-4"})})}),e.jsx(t,{title:"Checkbox list with per-item icons",children:e.jsx(o,{label:"Type",options:C,placeholder:"Search type...",icon:e.jsx(i,{className:"size-4"})})}),e.jsx(t,{title:"Options without counts",children:e.jsx(o,{label:"Status",options:I,placeholder:"Search status...",icon:e.jsx(i,{className:"size-4"})})}),e.jsx(t,{title:"React node labels (PriorityIndicator)",children:e.jsx(o,{label:"Priority",options:A,placeholder:"Search priority...",icon:e.jsx(i,{className:"size-4"})})}),e.jsx(t,{title:"Action mode",children:e.jsx(o,{label:"Actions",options:T,actionMode:!0,closeOnSelect:!0,placeholder:"Search actions...",icon:e.jsx(g,{className:"size-4"})})})]})};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
