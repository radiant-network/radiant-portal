import{r as g,j as e}from"./iframe-CUHTCraV.js";import{u as v,a as w,C as N,b as H,c as T,d as k,e as d}from"./chart-palette-preview-DM_klj00.js";import{B,C as P,a as M,b as D}from"./bar-rectangle-BB6ZhFBf.js";import{C as r,a as t,b as s,d as i}from"./card-BwvmyX8o.js";import{a as q}from"./story-section-B5jupzCR.js";import{h as z,m as K,f as I,b as _}from"./data-E4piqhSs.js";import"./preload-helper-PPVm8Dsz.js";import"./with-selector-Bj1dbq41.js";import"./index-DpmgubW-.js";import"./separator-Cfebd5mI.js";function n({axis:a,data:x,colorblindMode:h=!0,onClick:f,tooltip:y}){const c=g.useId(),u=v(x),j=w(a);return e.jsx(N,{config:j,children:e.jsxs(B,{accessibilityLayer:!0,data:u,layout:"vertical",margin:{bottom:12,left:6},children:[e.jsx(H,{id:c,data:u,colorblindMode:h}),e.jsx(P,{}),e.jsx(M,{axis:a,layout:"vertical"}),e.jsx(D,{dataKey:"count",id:c,layout:"vertical",onClick:f}),e.jsx(T,{isAnimationActive:!1,content:e.jsx(k,{hideLabel:!0,formatter:(F,O,S,A,b)=>y(b)})})]})})}n.__docgenInfo={description:`Horizontal bar chart with a single series, one bar per category.
