import{j as e,c as m,T as xe,b as ge,d as fe,e as ve}from"./iframe-CxSY7Paf.js";import{A as f,a as v}from"./avatar-BkqMVsef.js";import{g as N,a as j,b as h,A as M,c as oe,d as he}from"./avatar.utils-68RwjKgV.js";import{H as Ne,a as je,b as Ae}from"./hover-card-DDaM9cw5.js";import{C as Ue}from"./button-CQwjPxub.js";import{u as be}from"./i18n-BFt0O6_s.js";import{U as ye}from"./user-BsktR8Zv.js";import"./preload-helper-Dp1pzeXC.js";import"./index-Cw83H7Iw.js";import"./index-R3ZAVGYo.js";import"./action-button-C6pJwfjO.js";import"./dropdown-menu-7KW9uYmU.js";import"./index-w7TOK4tZ.js";import"./circle-BRvajDZy.js";import"./check-DpHxaibB.js";import"./separator-Co05gwko.js";function ce({user:s,size:n="sm",className:i}){const l=N(s),o=j(s.id),t=h({size:n,variant:"single"});return e.jsxs("div",{className:m("flex space-x-3 items-start",i),children:[e.jsx(f,{className:m(t.container(),"flex-shrink-0"),children:e.jsx(v,{className:m(t.fallback(),t.text(),o),children:l})}),e.jsxs("div",{className:"space-y-1 flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center space-x-2",children:[e.jsx("h4",{className:"text-sm font-semibold truncate",children:s.name}),s.organization&&e.jsx("p",{className:"text-xs text-muted-foreground truncate",children:s.organization})]}),s.email&&e.jsxs("div",{className:"group flex items-center space-x-1 hover:bg-accent/50 rounded px-1 py-0.5 -mx-1 transition-colors cursor-pointer",children:[e.jsx("a",{href:`mailto:${s.email}`,className:"text-xs text-muted-foreground truncate group-hover:text-primary hover:underline",onClick:c=>c.stopPropagation(),children:s.email}),e.jsx("div",{className:"opacity-0 group-hover:opacity-100 transition-opacity",children:e.jsx(Ue,{value:s.email,size:"sm",variant:"ghost",iconSize:12,className:"h-5 w-5 p-0 hover:bg-accent"})})]})]})]})}ce.__docgenInfo={description:"",methods:[],displayName:"AvatarUserItem",props:{user:{required:!0,tsType:{name:"AvatarUser"},description:""},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'sm'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""}}};function q({users:s,children:n}){const l=(Array.isArray(s)?s:[s]).sort((t,c)=>{const d=u=>{const p=u.trim().split(/\s+/);return p.length>1?p[p.length-1]:p[0]},x=d(t.name).toLowerCase(),g=d(c.name).toLowerCase();return x.localeCompare(g)}),o=l.length===1;return e.jsxs(Ne,{children:[e.jsx(je,{asChild:!0,children:n}),e.jsx(Ae,{className:"w-80 max-h-96 overflow-y-auto",side:"top",children:e.jsx("div",{className:o?"":"space-y-3",children:l.map(t=>e.jsx(ce,{user:t,size:"md"},t.id))})})]})}q.__docgenInfo={description:"",methods:[],displayName:"AvatarPopover",props:{users:{required:!0,tsType:{name:"union",raw:"AvatarUser | AvatarUser[]",elements:[{name:"AvatarUser"},{name:"Array",elements:[{name:"AvatarUser"}],raw:"AvatarUser[]"}]},description:""},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:""},className:{required:!1,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};function de({firstUser:s,additionalCount:n,allUsers:i,size:l="md",className:o}){const t=N(s),c=j(s.id),d=h({size:l,variant:"count",position:"first"}),x=h({size:l,variant:"count",position:"second"}),g=oe(l),u=n>M.MAX_COUNT_DISPLAY?`${M.MAX_COUNT_DISPLAY}+`:`+${n}`,p=e.jsxs("div",{className:m("flex items-center",o),title:`${s.name} and ${n} other${n>1?"s":""}`,children:[e.jsx(f,{className:d.container(),children:e.jsx(v,{className:m(d.fallback(),d.text(),c),children:t})}),e.jsx(f,{className:m(x.container(),g,"bg-background"),children:e.jsx(v,{className:m(x.fallback(),"bg-cyan-800/20 text-cyan-foreground"),children:u})})]});return i&&i.some(k=>k.email||k.organization)?e.jsx(q,{users:i,size:l,children:p}):p}de.__docgenInfo={description:"",methods:[],displayName:"CountAvatar",props:{size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},canAssign:{required:!1,tsType:{name:"boolean"},description:""},onAssignClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},firstUser:{required:!0,tsType:{name:"AvatarUser"},description:""},additionalCount:{required:!0,tsType:{name:"number"},description:""},allUsers:{required:!1,tsType:{name:"Array",elements:[{name:"AvatarUser"}],raw:"AvatarUser[]"},description:""}}};function me({users:s,size:n="md",className:i}){const[l,o]=s,t=N(l),c=N(o),d=j(l.id),x=j(o.id),g=h({size:n,variant:"dual",position:"first"}),u=h({size:n,variant:"dual",position:"second"}),p=oe(n),_=e.jsxs("div",{className:m("flex items-center",i),title:`${l.name}, ${o.name}`,children:[e.jsx(f,{className:g.container(),children:e.jsx(v,{className:m(g.fallback(),g.text(),d),children:t})}),e.jsx(f,{className:m(u.container(),p),children:e.jsx(v,{className:m(u.fallback(),u.text(),x),children:c})})]});return s.some(I=>I.email||I.organization)?e.jsx(q,{users:s,size:n,children:_}):_}me.__docgenInfo={description:"",methods:[],displayName:"DualAvatar",props:{size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},canAssign:{required:!1,tsType:{name:"boolean"},description:""},onAssignClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},users:{required:!0,tsType:{name:"tuple",raw:"[AvatarUser, AvatarUser]",elements:[{name:"AvatarUser"},{name:"AvatarUser"}]},description:""}}};function pe({user:s,size:n="md",className:i}){const l=N(s),o=j(s.id),t=h({size:n,variant:"single"}),c=e.jsx(f,{className:m(t.container(),i),title:s.name,children:e.jsx(v,{className:m(t.fallback(),t.text(),o),children:l})});return s.email||s.organization?e.jsx(q,{users:s,size:n,children:c}):c}pe.__docgenInfo={description:"",methods:[],displayName:"SingleAvatar",props:{size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},canAssign:{required:!1,tsType:{name:"boolean"},description:""},onAssignClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},user:{required:!0,tsType:{name:"AvatarUser"},description:""}}};function ue({size:s="md",className:n,canAssign:i,onAssignClick:l}){const{t:o}=be(),t=h({variant:"unassigned"}),c=he(s),d=o(i?"common.unassigned_avatar.can_assign":"common.unassigned_avatar.cannot_assign"),x=i===!0?"cursor-pointer":"cursor-default",u=i&&l?l:void 0,p=e.jsx(f,{className:m("relative flex shrink-0 overflow-hidden rounded-full","border-2 border-dashed border-muted-foreground/40 bg-muted/20","h-6 w-6",x,n),onClick:u,children:e.jsx(v,{className:m(t.fallback(),t.text()),children:e.jsx(ye,{className:c})})});return i!==void 0?e.jsx(xe,{children:e.jsxs(ge,{children:[e.jsx(fe,{asChild:!0,children:p}),e.jsx(ve,{children:e.jsx("p",{children:d})})]})}):p}ue.__docgenInfo={description:"",methods:[],displayName:"UnassignedAvatar",props:{size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},canAssign:{required:!1,tsType:{name:"boolean"},description:""},onAssignClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};function a({users:s=[],size:n="md",className:i,canAssign:l,onAssignClick:o}){const t=s.filter(d=>d&&d.id&&d.name),c=t.length;return c===0?e.jsx(ue,{size:n,className:i,canAssign:l,onAssignClick:o}):c===1?e.jsx(pe,{user:t[0],size:n,className:i,canAssign:l,onAssignClick:o}):c===2?e.jsx(me,{users:[t[0],t[1]],size:n,className:i,canAssign:l,onAssignClick:o}):e.jsx(de,{firstUser:t[0],additionalCount:c-1,allUsers:t,size:n,className:i,canAssign:l,onAssignClick:o})}a.__docgenInfo={description:`Avatar component that displays user assignment status
...
}`,...(ie=(le=w.parameters)==null?void 0:le.docs)==null?void 0:ie.source}}};const Je=["AllStates","Sizes","Unassigned","SingleUser","TwoUsers","MultipleUsers","SingleNameUsers","AssignmentStates","TableUsageExample"];export{A as AllStates,z as AssignmentStates,T as MultipleUsers,C as SingleNameUsers,y as SingleUser,U as Sizes,w as TableUsageExample,S as TwoUsers,b as Unassigned,Je as __namedExportsOrder,Ve as default};
