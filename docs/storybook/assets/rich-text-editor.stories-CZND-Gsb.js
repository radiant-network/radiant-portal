import{j as c}from"./iframe-ZUKLh1y0.js";import{u as l}from"./i18n-Dldl3Adp.js";import{R as n}from"./rich-text-editor-HQUQADO0.js";import"./preload-helper-Dp1pzeXC.js";import"./separator-BkcTXRGq.js";import"./index-CG-ZRbHY.js";import"./dropdown-menu-lWueQF7S.js";import"./index-BlRbp4g_.js";import"./circle-DQ25Nq_E.js";import"./check-tJGMWMh_.js";import"./chevron-down-HLnOMn69.js";const{fn:m}=__STORYBOOK_MODULE_TEST__,{action:e}=__STORYBOOK_MODULE_ACTIONS__,f={title:"Inputs/RichText Editor",component:n,args:{value:"<h3>Hello</h3>",onChange:m(),placeholder:"Placeholder"}},o={render:s=>{const{t:p}=l();return c.jsx(n,{value:s.value,onChange:e("onChange"),onBlur:e("onBlur"),placeholder:p("common.editor.placeholder"),wrapperClassName:"max-w-[500px]",autoFocus:!0})}};var r,t,a;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: args => {
    const {
      t
    } = useI18n();
