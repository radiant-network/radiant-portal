import{j as e}from"./iframe-CaCkF73x.js";import{E as i}from"./expandable-list-B4qDNMR4.js";import{S as n,a as r,b as l}from"./story-section-BzjNo_xI.js";import"./preload-helper-PPVm8Dsz.js";const S={title:"Components/Lists/Expandable List",component:i,args:{}},o=[1,2,3,4,5,6].map(s=>e.jsx("span",{children:s},s)),t={args:{visibleCount:3,items:o,emptyMessage:e.jsx(e.Fragment,{children:"Empty"})},render:s=>e.jsxs(n,{children:[e.jsx(r,{title:"Default",description:"Shows visibleCount items, then a “See more / See less” toggle.",children:e.jsx(i,{...s})}),e.jsx(r,{title:"Sizes",description:"Size controls the vertical spacing between items.",children:e.jsx("div",{className:"flex gap-12",children:["default","md","lg"].map(a=>e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(l,{children:a}),e.jsx(i,{size:a,visibleCount:3,items:o,emptyMessage:e.jsx(e.Fragment,{children:"Empty"})})]},a))})}),e.jsx(r,{title:"Empty",children:e.jsx(i,{visibleCount:3,items:[],emptyMessage:e.jsx("span",{children:"List is Empty"})})})]})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    visibleCount: 3,
    items: numberItems,
    emptyMessage: <>Empty</>
