import{j as s}from"./iframe-CoEcbA0Q.js";import{A as a}from"./anchor-link-CTPamJqf.js";import"./preload-helper-Dp1pzeXC.js";const g=["primary","secondary"],k=["default","xs","sm","lg"],x={title:"Links/AnchorLink",component:a,argTypes:{size:{options:k,control:{type:"select"}},variant:{options:g,control:{type:"select"}}},args:{external:!0,size:"default",variant:"primary",mono:!1}},n={args:{},render:r=>s.jsx(a,{...r,children:"Anchor Link"})},e={args:{variant:"secondary"},render:r=>s.jsx(a,{...r,children:"Anchor Link"})},o={args:{mono:!0},render:r=>s.jsx(a,{...r,children:"Anchor Link"})};var t,c,i;n.parameters={...n.parameters,docs:{...(t=n.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {},
  render: args => {
