import{j as e,r as w}from"./iframe-CgZaKe5d.js";import{aZ as K,a_ as B,u as A,bx as _,C as k,b as q,by as j,c as F,bz as V,bA as L,a as z,d as R,e as b}from"./chart-palette-preview-Bw6N7yF5.js";import{c as S,B as T,C as P,a as E,b as G}from"./bar-rectangle-CKrT7tvO.js";import{C as p,a as y,b as h,d as x}from"./card-CtUiCFoJ.js";import{a as M}from"./story-section-Cd-IQlgl.js";import{n as H,o as D}from"./data-CGl4bGS9.js";function N({id:a,dataKey:n,layout:l,patternIndex:d,color:u,onClick:t}){return e.jsx(S,{dataKey:n,fill:u,onClick:t,shape:s=>e.jsx(B,{...s,fill:`url(#${a}-bar-pattern-${d})`,style:t?{cursor:"pointer"}:void 0}),radius:2,children:e.jsx(K,{dataKey:n,className:"fill-foreground",fontSize:12,position:l=="horizontal"?"top":"middle",style:t?{cursor:"pointer"}:void 0})})}N.__docgenInfo={description:`Bar + Label
