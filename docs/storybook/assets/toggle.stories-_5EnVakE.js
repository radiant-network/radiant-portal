import{j as e}from"./iframe-DeENhpj3.js";import{T as i,B as u}from"./toggle-wg8mAVsR.js";import"./preload-helper-Dp1pzeXC.js";const l=["xxs","xs","sm","default","lg"],o=["default","outline"],N={title:"Toggle/Toggle",component:i,argTypes:{size:{options:l,control:{type:"select"}},variant:{options:o,control:{type:"select"}}},args:{disabled:!1}},t={render:()=>e.jsx("div",{className:"flex flex-col items-start gap-2",children:o.map(a=>e.jsx("div",{className:"flex gap-2 items-center",children:l.map(s=>e.jsxs(i,{size:s,variant:a,children:[e.jsx(u,{}),"Text"]},s))},a))})},r={render:()=>e.jsx("div",{className:"flex flex-col items-start gap-2",children:o.map(a=>e.jsx("div",{className:"flex gap-2 items-center",children:l.map(s=>e.jsx(i,{size:s,variant:a,children:e.jsx(u,{})},s))},a))})},n={render:()=>e.jsx("div",{className:"flex flex-col items-start gap-2",children:o.map(a=>e.jsx("div",{className:"flex gap-2 items-center",children:l.map(s=>e.jsx(i,{size:s,variant:a,children:"Text"},s))},a))})};var c,m,d;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`{
