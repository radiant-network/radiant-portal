import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{a as v}from"./index-B-lxVbXh.js";import{R as s,q as f}from"./query-builder-remote-DQDcrGW9.js";import{N as o}from"./numerical-filter-Dtb2ro4a.js";import{C as A}from"./applications-config-pyPLye2e.js";import{w as x,u as c,e as a}from"./index-B7YJKKKT.js";import{c as h}from"./config-mock-BXxtYAjK.js";import"./v4-CtRu48qb.js";import"./api-fYFwtGmU.js";import"./index-DQLiH3RP.js";import"./button-DxaAc8t_.js";import"./index-b4Krvw3J.js";import"./index-CECE1b4A.js";import"./index-CJPVTaBz.js";import"./ActionButton-DuC4fis2.js";import"./dropdown-menu-DGmzL58B.js";import"./index-DZeBqZZX.js";import"./index-CKWZTibS.js";import"./index-CS2et-gJ.js";import"./index-BlJj-Uol.js";import"./utils-D-KgF5mV.js";import"./check-DSCf8CVO.js";import"./createLucideIcon-BMP5cxO1.js";import"./button.variants-BQkt_1YJ.js";import"./index-C66Dxnp2.js";import"./ellipsis-BtlAG3ey.js";import"./spinner-DHVcj7-u.js";import"./tooltip-2a7OmUZw.js";import"./i18n-D_a2mOed.js";import"./iframe-Bv-7jxhC.js";import"./select-EcNoXCvM.js";import"./index-DDGWSPzp.js";import"./chevron-down-QEmn0_AS.js";import"./input-DyY2UfVx.js";import"./checkbox-BPlUEr5r.js";import"./label-BwU4_qxe.js";import"./less-than-or-equal-operator-icon-BI5aNTvi.js";import"./index-n0DPRcfI.js";import"./index-BjfAAjgr.js";import"./skeleton-Shk8p_SP.js";const y={...h,variant_exploration:{...h.variant_exploration,aggregations:{variant:{items:[{key:"impact_score",type:"numerical",defaults:{min:0,max:100,defaultMin:0,defaultMax:100,intervalDecimal:2,defaultOperator:s.GreaterThan}},{key:"age",type:"numerical",defaults:{min:0,max:120,defaultMin:0,defaultMax:120,intervalDecimal:0,defaultOperator:s.Between,rangeTypes:[{key:"year",name:"Year"},{key:"month",name:"Month"},{key:"day",name:"Day"}]}}]}}}},_e={title:"Feature/Query Filters/Numerical Filter",component:o,args:{field:{key:"impact_score",type:"numerical",defaults:{min:0,max:100,defaultMin:0,defaultMax:100,intervalDecimal:2,defaultOperator:s.GreaterThan}}},decorators:[e=>t.jsx(A,{config:y,children:t.jsx(e,{})})]},l={render:e=>t.jsx("div",{className:"space-y-6",children:t.jsx(o,{...e})}),play:async({canvasElement:e})=>{const r=x(e),n=r.getByTestId("impact_score_value");await c.type(n,"75"),a(n).toHaveValue(75);const i=r.getByRole("button",{name:/apply/i});a(i).toBeEnabled(),await c.click(i)}},p={render:e=>(v("activeQuery")(f.updateActiveQueryField(y.variant_exploration.app_id,{field:"impact_score",value:[]})),t.jsx("div",{className:"space-y-6",children:t.jsx(o,{...e})})),play:async({canvasElement:e})=>{const n=await x(e).findByText("No data");await c.click(n),a(n.previousElementSibling).toBeChecked()}},m={args:{field:{key:"impact_score",type:"multiple"}},render:e=>t.jsx("div",{className:"space-y-6",children:t.jsx(o,{...e})})},u={args:{field:{key:"age",type:"numerical",defaults:{min:0,max:120,defaultMin:0,defaultMax:120,intervalDecimal:0,defaultOperator:s.Between}}},render:e=>(v("activeQuery")(f.updateActiveQueryField(y.variant_exploration.app_id,{field:"age",value:[]})),t.jsx("div",{className:"space-y-6",children:t.jsx(o,{...e})})),parameters:{docs:{description:{story:'A numerical filter with range constraints. Note: Shows ">" operator by default due to global config override.'}}}},d={args:{field:{key:"age",type:"numerical",defaults:{min:0,max:120,defaultMin:0,defaultMax:120,intervalDecimal:0,defaultOperator:s.Between,rangeTypes:[{key:"year",name:"Year"},{key:"month",name:"Month"},{key:"day",name:"Day"}]}}},render:e=>(v("activeQuery")(f.updateActiveQueryField(y.variant_exploration.app_id,{field:"age_unit",value:[]})),t.jsx("div",{className:"space-y-6",children:t.jsx(o,{...e})})),play:async({canvasElement:e})=>{const r=x(e),n=r.getByText("Between");a(n).toBeInTheDocument();const i=r.getByTestId("age_min"),B=r.getByTestId("age_max");a(i).toBeInTheDocument(),a(B).toBeInTheDocument();const T=r.getByText("Year");a(T).toBeInTheDocument();const g=r.getByText("Clear");a(g).toBeDisabled(),await c.type(i,"50"),a(g).toBeEnabled(),await c.click(g),a(i).toHaveValue(0),a(B).toHaveValue(120),a(T).toHaveTextContent("Year")},parameters:{docs:{description:{story:"A numerical filter with range type options (Year, Month, Day) and unit selection. Tests validate range operator changes, unit selection, no data visibility, and clear functionality."}}}};var w,D,_;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: args => {
...
}`,...(O=(Q=d.parameters)==null?void 0:Q.docs)==null?void 0:O.source}}};const Ie=["Default","NoDataToggle","NoDataToggleHidden","RangeFilterWithInterval","RangeFilterWithRangeTypes"];export{l as Default,p as NoDataToggle,m as NoDataToggleHidden,u as RangeFilterWithInterval,d as RangeFilterWithRangeTypes,Ie as __namedExportsOrder,_e as default};
