import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as i}from"./index-CGj_12n1.js";import{U as n,R as t,a as Y}from"./table-header-user-filter-xTHRT-4z.js";import"./button-DriQYAyp.js";import"./index-COcwYKbe.js";import"./index-D8dqFcAi.js";import"./index-BBPXtLXU.js";import"./action-button-BiAXKMq7.js";import"./utils-D-KgF5mV.js";import"./dropdown-menu-CFPCuvYI.js";import"./index-CcLUv2_A.js";import"./index-CphM_NEg.js";import"./Combination-Bb6GvI2f.js";import"./index-ButkbYdn.js";import"./index-A6VgBoaw.js";import"./index-BOEjv1S3.js";import"./index-CIckazZy.js";import"./check-DRc1RmCY.js";import"./createLucideIcon-8Lr1oLzj.js";import"./separator-6xmuS_PL.js";import"./button.variants-Du9eY_ux.js";import"./index-C66Dxnp2.js";import"./spinner-BMSZ66Eg.js";import"./tooltip-eZCTYbea.js";import"./i18n-BBHUq9Xw.js";import"./iframe-BUr8v6fQ.js";import"./i18next-DOi7g2fS.js";import"./popover-CX89_Z95.js";import"./avatar-BO-Q3Qt0.js";import"./index-DxlLpgFR.js";import"./avatar.utils-MvOOLP0y.js";import"./user-CZ8KFWeE.js";import"./x-CubKniSv.js";import"./checkbox-B0xIRynn.js";import"./index-qxuqJ0RB.js";const He={title:"Assignation/UserSelection",component:n,parameters:{layout:"padded"}},r=[{id:"user-1",name:"Jean-François Soucy",email:"jeanfrancois.soucy.med@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-2",name:"Julie M. Gauthier",email:"julie.m.gauthier.hsj@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-3",name:"Jacques Michaud",email:"jacques.michaud.med@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-4",name:"Fadi Hamdan",email:"fadi.hamdan@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-5",name:"Catalina Maftei",email:"catalina.maftei@ssss.gouv.qc.ca",organization:"LDM-CHUSJ"},{id:"user-6",name:"Sarah Wilson",email:"sarah.wilson@hospital.ca",organization:"Toronto General"},{id:"user-7",name:"David Brown",email:"david.brown@clinic.ca",organization:"Vancouver Clinic"}],Z=()=>{const[s,a]=i.useState([]);return e.jsx("div",{className:"max-w-lg",children:e.jsx(n,{availableUsers:r,selectedUsers:s,onUsersChange:a})})},o={render:()=>e.jsx(Z,{})},ee=()=>{const[s,a]=i.useState([r[0]]);return e.jsx("div",{className:"max-w-lg",children:e.jsx(n,{availableUsers:r,selectedUsers:s,onUsersChange:a})})},l={render:()=>e.jsx(ee,{})},se=()=>{const[s,a]=i.useState([r[0],r[1],r[2]]);return e.jsx("div",{className:"max-w-lg",children:e.jsx(n,{availableUsers:r,selectedUsers:s,onUsersChange:a})})},c={render:()=>e.jsx(se,{})},re=()=>{const[s,a]=i.useState([]);return e.jsxs("div",{className:"max-w-2xl space-y-6",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-semibold mb-4",children:"User Selection Popover"}),e.jsx(Y,{availableUsers:r,selectedUsers:s,onUsersChange:a,triggerText:"Assignation"})]}),e.jsxs("div",{className:"p-4 bg-gray-50 rounded-lg",children:[e.jsx("h4",{className:"font-medium mb-2",children:"État actuel:"}),e.jsx("p",{className:"text-sm text-gray-600",children:s.length===0?"Aucun utilisateur sélectionné":`${s.length} utilisateur(s) sélectionné(s): ${s.map(v=>v.name).join(", ")}`})]})]})},d={render:()=>e.jsx(re,{})},ae=()=>{const[s,a]=i.useState([]);return e.jsxs("div",{className:"max-w-2xl space-y-6",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-semibold mb-4",children:"User Selection Demo"}),e.jsx(n,{availableUsers:r,selectedUsers:s,onUsersChange:a})]}),e.jsxs("div",{className:"p-4 bg-gray-50 rounded-lg",children:[e.jsx("h4",{className:"font-medium mb-2",children:"État actuel:"}),e.jsx("p",{className:"text-sm text-gray-600",children:s.length===0?"Aucun utilisateur sélectionné":`${s.length} utilisateur(s) sélectionné(s): ${s.map(v=>v.name).join(", ")}`})]})]})},m={render:()=>e.jsx(ae,{})},p={render:()=>e.jsxs("div",{className:"max-w-lg space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Read-Only User Selection (Empty)"}),e.jsx(t,{selectedUsers:[]}),e.jsx("p",{className:"text-sm text-gray-600",children:"Note: Component returns null when no users are selected"})]})},x={render:()=>e.jsxs("div",{className:"max-w-lg space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Read-Only User Selection (Single User)"}),e.jsx(t,{selectedUsers:[r[0]]}),e.jsxs("div",{className:"text-sm text-gray-600",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Selected:"})," ",r[0].name]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Organization:"})," ",r[0].organization]})]})]})},g={render:()=>e.jsxs("div",{className:"max-w-lg space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Read-Only User Selection (Multiple Users)"}),e.jsx(t,{selectedUsers:[r[0],r[1],r[2]]}),e.jsxs("div",{className:"text-sm text-gray-600",children:[e.jsx("p",{children:e.jsx("strong",{children:"Selected Users:"})}),e.jsx("ul",{className:"list-disc list-inside ml-2",children:[r[0],r[1],r[2]].map(s=>e.jsxs("li",{children:[s.name," (",s.organization,")"]},s.id))})]})]})},u={render:()=>{const s={id:"not-assign",name:"Not assigned",organization:""};return e.jsxs("div",{className:"max-w-lg space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Read-Only User Selection (Not Assigned)"}),e.jsx(t,{selectedUsers:[s]}),e.jsxs("div",{className:"text-sm text-gray-600",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Status:"})," No assignment"]}),e.jsx("p",{children:"Shows the unassigned state with the user icon"})]})]})}},h={render:()=>{const s={id:"not-assign",name:"Not assigned",organization:""};return e.jsxs("div",{className:"max-w-lg space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Read-Only User Selection (Mixed)"}),e.jsx(t,{selectedUsers:[r[0],s,r[2]]}),e.jsxs("div",{className:"text-sm text-gray-600",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Note:"})," Shows mix of assigned users and unassigned state"]}),e.jsx("p",{children:"Demonstrates the different avatar styles in read-only mode"})]})]})}},U={render:()=>{const s=[r[0],r[1]];return e.jsxs("div",{className:"max-w-2xl space-y-6",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Editable vs Read-Only Comparison"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-2",children:"Read-Only Version:"}),e.jsx(t,{selectedUsers:s}),e.jsx("p",{className:"text-sm text-gray-500 mt-1",children:"No interaction possible - display only"})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-2",children:"Editable Version:"}),e.jsx(n,{availableUsers:r,selectedUsers:s,onUsersChange:()=>{}}),e.jsx("p",{className:"text-sm text-gray-500 mt-1",children:"Interactive - allows searching and removing users"})]})]})]})}};var y,j,N;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
