import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{f as u}from"./index-B7YJKKKT.js";import{a as re}from"./index-B-lxVbXh.js";import{w as Jt,x as Yt,n as Xt,B as H,S as oe,v as W,q as O}from"./query-builder-remote-BihcgTEW.js";import{d as D,e as y,C as Oe,f as v,h as $t,i as Kt,j as Gt,k as qe,l as Zt,m as en,o as Re,n as Ee,P as tn,a as nn,u as rn,p as Le,Q as an,b as on,q as Q,g as T}from"./utils-D328gjZm.js";import{R as x,r as p}from"./index-DQLiH3RP.js";import{b as ze,c as sn,P as Ue,u as ln,d as un}from"./index-D-AYaadb.js";import{i as dn,u as cn}from"./dropdown-menu-CjEDsahn.js";import{c as Ve,R as mn,T as hn,b as fn}from"./index-BpZe7dkh.js";import{u as yn}from"./index-ClAAgfyD.js";import{c as R}from"./utils-D-KgF5mV.js";import{C as vn}from"./chevron-right--l3G0NFC.js";import{C as pn}from"./chevron-down-QEmn0_AS.js";import{B as m}from"./button-Bpnaj0wn.js";import{T as He}from"./trash-DCT5GB8X.js";import{T as j,a as k,b as F}from"./tooltip-CUn8_aCA.js";import{D as se,a as le,b as ue,c as de,d as ce,e as me}from"./dialog-D280iRMv.js";import{t as A,n as he,g as we,a as gn,e as Cn,m as je,b as L,u as We,s as Je,F as Ye,c as Xe,d as $e,f as Ke,h as Ge,i as Ze,o as et,j as tt,P as nt,k as _,l as M,p as bn,q as ee}from"./en-US-DKkvlcu_.js";import{I as it}from"./input-DyY2UfVx.js";import{c as fe}from"./createLucideIcon-BMP5cxO1.js";import"./i18n-CQ-cu_Xg.js";import{S as xn}from"./spinner-DHVcj7-u.js";import{n as Sn}from"./number-format-BmdRvOec.js";import{C as Qn}from"./checkbox-CO27iIkV.js";import{c as qn}from"./index-C66Dxnp2.js";import{a as wn}from"./alert-dialog-store-CZoSfA8g.js";import{A as jn}from"./ActionButton-B-iQPL2P.js";import"./button.variants-Czj0iLzG.js";import{d as ke}from"./capitalize-CYSINAQZ.js";import{S as kn}from"./switch-DBZYXyXU.js";import{S as Fn,a as In,L as Pn}from"./list-item-with-action-C826-Qi3.js";import{S as An,a as Dn,c as Nn,d as Bn,e as Tn}from"./select-CrK497D9.js";import{S as _n}from"./star-DfQf5eJj.js";import{U as Mn}from"./user-Dv_C2EEw.js";import"./v4-CtRu48qb.js";import"./api-CCaSjEdf.js";import"./less-than-or-equal-operator-icon-BI5aNTvi.js";import"./not-in-operator-icon-DdiM-lgK.js";import"./chevron-left-DGpQFcG5.js";import"./x-ClsbQ_rO.js";import"./conditional-wrapper-BBX8pIPQ.js";import"./Combination-9qYnPkZM.js";import"./index-8F5FSkgb.js";import"./index-CECE1b4A.js";import"./index-CJPVTaBz.js";import"./index-C5A_jyAq.js";import"./separator-DcuX0n1V.js";import"./check-DSCf8CVO.js";import"./index-Czeu9DHN.js";import"./index-DfzZ_IvS.js";import"./label-Buk2CdJ1.js";import"./info-rYv3sqpq.js";import"./iframe-CpGvlRZP.js";import"./index-DDGWSPzp.js";import"./ellipsis-BtlAG3ey.js";import"./pen-DfDDAb28.js";/**
...
meaning the query can be selected for a combine operation`},{key:"isActive",value:{name:"boolean",required:!0},description:"Call this function to know if the Query is active"},{key:"setAsActive",value:{name:"void",required:!0},description:"Call this function to set the Query as active"},{key:"addPill",value:{name:"signature",type:"function",raw:"(pill: IValueQuery) => void",signature:{arguments:[{type:{name:"IValueQuery"},name:"pill"}],return:{name:"void"}},required:!0},description:"Call this function to add pill to the Query"},{key:"removePillById",value:{name:"signature",type:"function",raw:"(pillId: string) => void",signature:{arguments:[{type:{name:"string"},name:"pillId"}],return:{name:"void"}},required:!0},description:"Call this function to remove pill from the Query by ID"},{key:"removePillByFieldOrIndex",value:{name:"signature",type:"function",raw:"(indexOfField: string | number) => void",signature:{arguments:[{type:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},name:"indexOfField"}],return:{name:"void"}},required:!0},description:"Call this function to remove pill from the Query by field name"},{key:"changeCombineOperator",value:{name:"void",required:!0},description:"Call this function to set the Query as active"},{key:"isReferencedInActiveQuery",value:{name:"boolean",required:!0},description:"Call this function to know if the Query is referenced in the active query"},{key:"hasCustomPill",value:{name:"boolean",required:!0},description:"Call this function to know if the Query has a custom pill"}]}},description:""}}};function St(){const{query:t}=D(),i=v(),[n,r]=p.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsxs(j,{children:[e.jsx(k,{asChild:!0,children:e.jsx(m,{iconOnly:!0,variant:"ghost",size:"sm",onClick:()=>r(!0),disabled:t.hasCustomPill(),children:e.jsx(rt,{})})}),e.jsx(F,{className:"max-w-[200px]",children:t.hasCustomPill()?i.queryBar.customPill.cannotSaveAsCustomPill:i.queryBar.customPill.createTooltip})]}),e.jsx(xt,{open:n,onOpenChange:r,query:t})]})}St.__docgenInfo={description:"",methods:[],displayName:"QueryBarSaveAction"};function Qt(){const{customPillConfig:t}=y();return e.jsxs("div",{className:`
      ...
      `,children:[e.jsx(Qn,{size:"sm",checked:t.isSelected(),onClick:i=>{i.stopPropagation(),t.toggleSelect(!t.isSelected())}}),e.jsxs("span",{className:"text-xs font-medium",children:["Q",t.index()+1]})]}):null}wt.__docgenInfo={description:"",methods:[],displayName:"QueryBarSelector"};const mi=qn({base:"flex flex-1 py-2 px-3 border ",variants:{active:{true:["border-primary/75 bg-primary/10"],false:["border-muted-foreground/20 bg-muted/35 text-muted-foreground"]}},defaultVariants:{active:!1}});function jt({query:t}){const i=t.isActive(),n=v(),{enableCombine:r}=y(),a=()=>{i||t.setAsActive()};return e.jsx(Zt.Provider,{value:{query:t},children:e.jsxs("div",{"data-query-active":i,className:"flex group/query",onClick:a,children:[e.jsx(gt,{}),r&&e.jsx(wt,{}),e.jsx("div",{className:mi({active:i}),children:e.jsx("div",{className:"flex flex-1 items-center justify-between",children:t.isEmpty()?e.jsx(e.Fragment,{children:n.queryBar.empty}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"flex-1",children:Xt(t.raw())&&e.jsx("div",{className:"flex items-center flex-wrap pr-2",children:e.jsx(en,{sqon:t.raw()})})}),e.jsx(qt,{})]})})}),t.isNotEmpty()&&e.jsx(Qt,{})]})})}jt.__docgenInfo={description:"",methods:[],displayName:"QueryBar",props:{query:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  /**
   * ID of the Query
   */
  id: string;
...
}`,...(Me=(_e=V.parameters)==null?void 0:_e.docs)==null?void 0:Me.source}}};const Kr=["Default","CustomPill","QueryPillFilter"];export{U as CustomPill,z as Default,V as QueryPillFilter,Kr as __namedExportsOrder,$r as default};
