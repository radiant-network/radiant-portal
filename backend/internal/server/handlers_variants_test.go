...
func (m *MockRepository) GetVariantInterpretedCases(int, types.ListQuery) (*[]types.VariantInterpretedCase, *int64, error) {
	...
	return &[]types.VariantInterpretedCase{
		{CaseId: 1, SeqId: 1, TranscriptId: "T002", PatientId: 1,
			...
			DiagnosisLabCode: "CQGC", DiagnosisLabName: "Quebec Clinical Genomic Center",
			AnalysisCatalogCode: "WGA", AnalysisCatalogName: "Whole Genome Analysis", StatusCode: "in_progress",
		...
		{CaseId: 1, SeqId: 2, TranscriptId: "T001", PatientId: 2,
			...
			DiagnosisLabCode: "CQGC", DiagnosisLabName: "Quebec Clinical Genomic Center",
			AnalysisCatalogCode: "WGA", AnalysisCatalogName: "Whole Genome Analysis", StatusCode: "in_progress", Phenotypes: make(types.JsonArray[types.Term], 0)},
...
func (m *MockRepository) GetVariantUninterpretedCases(int, types.ListQuery) (*[]types.VariantUninterpretedCase, *int64, error) {
	...
	return &[]types.VariantUninterpretedCase{
		{CaseId: 3,
			...
			SeqId:                     1,
			SubmitterSampleId:         "S13232",
			AffectedStatusName:        "Affected",
			Phenotypes:                make(types.JsonArray[types.Term], 0),
			FilterIsPass:              &filterIsNotPass,
			Zygosity:                  "HET",
			TransmissionMode:          "autosomal_recessive",
		...
		{CaseId: 4,
			RelationshipToProbandCode: "proband",
			SeqId:                     10,
			SubmitterSampleId:         "S13233",
			AffectedStatusName:        "Affected",
			Phenotypes:                make(types.JsonArray[types.Term], 0),
			FilterIsPass:              &filterIsPass,
			Zygosity:                  "HOM",
			TransmissionMode:          "autosomal_dominant",
			DiagnosisLabCode:          "CQGC", DiagnosisLabName: "Quebec Clinical Genomic Center",
			UpdatedOn:          time.Date(2021, 9, 12, 12, 8, 0, 0, time.UTC),
			PrimaryConditionId: "MONDO:0700092", PrimaryConditionName: "neurodevelopmental disorder",
			AnalysisCatalogCode: "WGA", AnalysisCatalogName: "Whole Genome Analysis",
			InfoQd:          float32(0.4),
			GenotypeQuality: 100,
			AdAlt:           5,
			AdTotal:         10,
		...
		"list": [
			{
				...
				"diagnosis_lab_code":"CQGC", 
				"diagnosis_lab_name":"Quebec Clinical Genomic Center", 
				"filter_is_pass":false, 
				"observed_phenotypes":[], 
				"relationship_to_proband":"proband", 
				"seq_id":1, 
				"submitter_sample_id":"S13232", 
				"transmission_mode":"autosomal_recessive", 
