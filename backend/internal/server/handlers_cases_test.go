...
func (m *MockRepository) GetCaseEntity(caseId int) (*types.CaseEntity, error) {
	return &types.CaseEntity{
		...
		Tasks: types.JsonArray[types.CaseTask]{
			{ID: 1, TypeCode: "ngba", CreatedOn: time.Date(2021, 10, 12, 13, 8, 0, 0, time.UTC), PatientCount: 3, PatientsUnparsed: "mother, father", Patients: types.JsonArray[string]{"mother", "father", "proband"}},
		},
