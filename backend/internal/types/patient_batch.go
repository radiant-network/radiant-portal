...
type PatientBatch struct {
	...
	SubmitterPatientIdType  TrimmedString `json:"submitter_patient_id_type" toml:"submitter_patient_id_type" binding:"required"`
...
type CreatePatientBatchBody struct {
	Patients []*PatientBatch `json:"patients" binding:"required,min=1,dive,required"`
