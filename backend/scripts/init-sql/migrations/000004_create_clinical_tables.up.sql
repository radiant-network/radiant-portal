...
(
    ...
    "name"     TEXT NOT NULL,
    "category" TEXT NOT NULL REFERENCES "organization_category" ("code")
);
...
(
    ...
    "sex"                      TEXT NOT NULL REFERENCES "sexe" ("code"),
    "dob"                      DATE,
...
(
    "id"                       INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "status"                   TEXT      NOT NULL REFERENCES "status" NOT NULL,
    "priority"                 TEXT      NOT NULL REFERENCES "priority" ("code"),
    "request_code"             TEXT,
...
(
    ...
    "type"              TEXT REFERENCES "case_type" ("code") NOT NULL,
    "status"            TEXT                                  NOT NULL REFERENCES "status" ("code"),
...
(
    ...
    "relationship_to_proband" TEXT                                NOT NULL REFERENCES "family_relationship" ("code"),
    "affected_status"         TEXT                                NOT NULL REFERENCES "affected_status" ("code")
);
...
(
    ...
    "interpretation"   TEXT REFERENCES "obs_interpretation" ("code"),
    "note"             TEXT
);
...
(
    "id"               INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "category"         TEXT NOT NULL REFERENCES "sample_category" ("code"),
    "type"             TEXT NOT NULL REFERENCES "sample_type" ("code"),
    "parent_sample_id" INTEGER REFERENCES "sample" ("id"),
    "tissue_site"      TEXT,
    "histology"        TEXT REFERENCES "histology_type" ("code"),
    "submitter_id"     TEXT
);
...
(
    ...
    "experimental_strategy" TEXT REFERENCES "experimental_strategy" ("code"),
    "status"                TEXT                                NOT NULL REFERENCES "status" ("code"),
...
(
    "id"          INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "type"        TEXT REFERENCES "task_type" ("code") NOT NULL,
...
(
    "id"            INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "name"          TEXT                                    NOT NULL,
    "data_category" TEXT                                    NOT NULL REFERENCES "data_category" ("code"),
    "data_type"     TEXT REFERENCES "data_type" ("code")   NOT NULL,
    "format"        TEXT REFERENCES "file_format" ("code") NOT NULL,
