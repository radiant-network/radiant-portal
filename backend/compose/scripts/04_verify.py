...
PASSWORD = "Demo12345!"
# user -> password (root has none on the allin1 image)
USERS = {"root": None, "alice": PASSWORD, "bob": PASSWORD,
         "wendy": PASSWORD, "dora": PASSWORD}
...
MATRIX = {
    ...
    ("dora",  "tenant_a"): {1001: True,  1002: True,  1003: True},   # admin_role bypass
    ("dora",  "tenant_b"): {2001: True,  2002: True},
