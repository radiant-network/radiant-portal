...
var orgResolvedTenantRoutes = map[string]bool{
	...
	// The cases named in the body; the action is required at every lab they resolve to.
	"POST /:tenant/cases/assignment_candidates": true,
...
var expectedTenantActions = map[string]string{
	...
	"POST /:tenant/cases/assignment_candidates":                  types.ActionEditCase,
