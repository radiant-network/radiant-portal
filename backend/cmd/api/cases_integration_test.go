...
func Test_SearchCasesHandler_WithCriteria(t *testing.T) {
	expected := `{"list": [{"analysis_catalog_code":"WGA", "analysis_catalog_name":"Whole Genome Analysis", "case_type":"germline_family", "case_id":7, "created_on":"2021-09-12T13:08:00Z", "proband_id":20, "submitter_proband_id":"MRN-283792", "priority_code":"routine", "project_code":"N2", "project_name":"NeuroDev Phase II", "ordering_organization_code":"CHOP", "ordering_organization_name":"Children Hospital of Philadelphia", "status_code":"revoke", "updated_on":"2021-09-12T13:08:00Z", "has_variants":true}], "count": 1}`
	body := `{
			"additional_fields":[],
...
func Test_SearchCasesHandler_WithAdditionalFields(t *testing.T) {
	expected := `{"list": [{"analysis_catalog_code":"WGA", "analysis_catalog_name":"Whole Genome Analysis", "case_type":"germline_family", "case_id":7, "created_on":"2021-09-12T13:08:00Z", "organization_code":"CHUSJ", "proband_id":20, "submitter_proband_id":"MRN-283792", "primary_condition_id":"MONDO:0000003", "primary_condition_name":"colorblindness, partial", "priority_code":"routine", "project_code":"N2", "project_name":"NeuroDev Phase II", "ordering_organization_code":"CHOP", "ordering_organization_name":"Children Hospital of Philadelphia", "status_code":"revoke", "updated_on":"2021-09-12T13:08:00Z", "has_variants":true}], "count": 1}`
	body := `{
...
func Test_CaseEntityHandler(t *testing.T) {
	expected := `{
		"sequencing_requests":[
			{"id":1, "submitter_sequencing_request_id":"SR-1-PROBAND", "service_code":"75022", "service_name":"Normal Genome Sequencing", "patient_id":3, "relationship_to_proband":"proband", "affected_status_code":"affected", "status_code":"completed", "created_on":"2021-09-12T13:08:00Z", "updated_on":"2021-09-12T13:08:00Z"},
			{"id":2, "submitter_sequencing_request_id":"SR-1-MOTHER", "service_code":"75022", "service_name":"Normal Genome Sequencing", "patient_id":1, "relationship_to_proband":"mother", "affected_status_code":"affected", "status_code":"submitted", "created_on":"2021-09-12T13:08:00Z", "updated_on":"2021-09-12T13:08:00Z"},
			{"id":3, "submitter_sequencing_request_id":"SR-1-FATHER", "service_code":"75020", "service_name":"Normal Exome Sequencing", "patient_id":2, "relationship_to_proband":"father", "affected_status_code":"non_affected", "status_code":"draft", "created_on":"2021-09-12T13:08:00Z", "updated_on":"2021-09-12T13:08:00Z"}
		],
		"sequencing_experiments":[
			{"affected_status_code":"affected", "experimental_strategy_code":"wgs", "patient_id":3, "relationship_to_proband":"proband", "sample_id":1, "sample_submitter_id":"S13224", "sample_type_code": "dna", "seq_id":1, "status_code":"completed", "sequencing_request_id":1, "updated_on":"2021-09-12T13:08:00Z", "histology_code": "normal", "has_variants": true},
