...
VALUES (1, 'F-72-1', 63, 'alive',    'male',    '2026-02-01', NULL,         'radiant'),
       (2, 'F-73-1', 64, 'alive',    'female',  NULL,         '2026-10-15', 'radiant'),
       (3, 'F-73-2', 64, 'deceased', 'unknown', NULL,         NULL,         'radiant'),
       (4, 'F-74-1', 65, 'alive',    'male',    '2026-03-01', NULL,         'radiant')
