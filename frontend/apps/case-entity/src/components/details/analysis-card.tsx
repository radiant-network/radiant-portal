          ...
          <div className="flex w-full justify-between gap-4">
            <div className="flex flex-col gap-2 flex-1">
              ...
              <InformationField
                ...
                labelTooltipsText={t('case_entity.details.prescribing_inst_tooltip')}
              ...
              <InformationField
                ...
                labelTooltipsText={t('case_entity.details.diag_lab_tooltip')}
              >
              ...
              <div>
                <Select value={priority} onValueChange={setPriority}>
                  <SelectTrigger className="min-w-[160px] max-w-[180px] h-7">
                    <SelectValue>
                      <div className="text-xs font-medium">{selectedPriority?.label}</div>
                    </SelectValue>
                  </SelectTrigger>
                  <SelectContent>
                    ...
                    <SelectValue>
                      <div className="flex items-center gap-2 text-xs font-medium">
                        {selectedStatus && selectedStatus.icon && (
                          <selectedStatus.icon className="w-4 h-4 text-blue-700" />
                        )}
