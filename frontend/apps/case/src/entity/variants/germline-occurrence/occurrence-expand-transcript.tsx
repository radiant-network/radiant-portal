import { type ExpandedGermlineSNVOccurrence, type GermlineSNVOccurrence } from '@/api/api';
...
import { getDbSnpUrl, getEnsemblGeneUrl, getOmimOrgUrl } from '@/components/base/variant/utils';
