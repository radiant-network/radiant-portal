 ...
 * (lowercase letters, numbers, underscores; must start with a letter) and is capped at 50. The
 * duplicate-code check (409-equivalent) is enforced in the sheet against the current list, not here.
 */
