...
export interface SampleBatch {
    /**
     * FetusId, unlike SubmitterPatientId, is not mutually exclusive with it: PatientId stays the mother the sample was physically drawn from, while FetusId (optional) says whose genome the sample\'s sequencing data represents — needed to attribute frequency/occurrence data to the right distinct individual. Nil when unknown at ingestion time.
     * @type {number}
