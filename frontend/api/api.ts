 ...
 * @export
 * @interface PatchCaseResponse
 */
export interface PatchCaseResponse {
    /**
     * 
     * @type {number}
     * @memberof PatchCaseResponse
     */
    'case_id'?: number;
    /**
     * 
...
export const ActionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        listActions: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ActionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listActions(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ActionResponse>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listActions(options);
...
export const ActionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listActions(options?: RawAxiosRequestConfig): AxiosPromise<Array<ActionResponse>> {
            return localVarFp.listActions(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ActionsApi extends BaseAPI {
     ...
     * @memberof ActionsApi
     */
    public listActions(options?: RawAxiosRequestConfig) {
        return ActionsApiFp(this.configuration).listActions(options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const CasesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} tenant Tenant code
         * @param {number} caseId Case ID
         * @param {CasePatch} casePatch Fields to change
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchCase: async (tenant: string, caseId: number, casePatch: CasePatch, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tenant' is not null or undefined
            assertParamExists('patchCase', 'tenant', tenant)
            // verify required parameter 'caseId' is not null or undefined
            assertParamExists('patchCase', 'caseId', caseId)
            // verify required parameter 'casePatch' is not null or undefined
            assertParamExists('patchCase', 'casePatch', casePatch)
            const localVarPath = `/{tenant}/cases/{case_id}`
                .replace(`{${"tenant"}}`, encodeURIComponent(String(tenant)))
                .replace(`{${"case_id"}}`, encodeURIComponent(String(caseId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(casePatch, localVarRequestOptions, configuration)
...
export const CasesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async patchCase(tenant: string, caseId: number, casePatch: CasePatch, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PatchCaseResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchCase(tenant, caseId, casePatch, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const CasesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        patchCase(tenant: string, caseId: number, casePatch: CasePatch, options?: RawAxiosRequestConfig): AxiosPromise<PatchCaseResponse> {
            return localVarFp.patchCase(tenant, caseId, casePatch, options).then((request) => request(axios, basePath));
        },
        /**
         * Partially updates existing cases — see the request body for updatable fields. Each case is looked up by (project_code, submitter_case_id); CASE-012 is returned if not found. Array fields are appended, not replaced.
         * @summary Partially update existing cases (batch)
...
export class CasesApi extends BaseAPI {
     ...
     * @memberof CasesApi
     */
    public patchCase(tenant: string, caseId: number, casePatch: CasePatch, options?: RawAxiosRequestConfig) {
        return CasesApiFp(this.configuration).patchCase(tenant, caseId, casePatch, options).then((request) => request(this.axios, this.basePath));
    }
...
export const RolesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Creates a custom role in the tenant in the path. Requires the `can_manage_role` action. Returns an empty 201.  `code` is immutable after creation, must match `[a-z][a-z0-9_]*` (max 50) and be unique per tenant; `name_en` is required and each name stays unique per tenant too (409). `name_fr`/`description_fr` fall back to their English counterparts. `actions` must list at least one, and every one must exist and be grantable — a reserved action such as `can_manage_user` yields 422. `scope` is derived from the actions; a created role is never `is_default`.
         ...
         * @throws {RequiredError}
         */
        getRole: async (tenant: string, code: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tenant' is not null or undefined
            assertParamExists('getRole', 'tenant', tenant)
            // verify required parameter 'code' is not null or undefined
            assertParamExists('getRole', 'code', code)
            const localVarPath = `/{tenant}/roles/{code}`
                .replace(`{${"tenant"}}`, encodeURIComponent(String(tenant)))
                .replace(`{${"code"}}`, encodeURIComponent(String(code)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        /**
         * Replaces the labels and actions of the custom role with the code in the path. Requires the `can_manage_role` action. Returns an empty 200.  Full replacement, not a patch: an omitted optional field is cleared, and the `actions` listed become the role\'s whole set, so one left out is revoked from every holder. `name_fr`/`description_fr` fall back to their English counterparts; each name stays unique per tenant (409). `code` is immutable; `scope` is re-derived from the actions. Every action must be grantable (422); a seeded role is locked (403).
         * @summary Edit a custom role
         * @param {string} tenant Tenant code
         * @param {string} code Role code
         * @param {UpdateRoleRequest} updateRoleRequest Desired state of the role
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateRole: async (tenant: string, code: string, updateRoleRequest: UpdateRoleRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tenant' is not null or undefined
            assertParamExists('updateRole', 'tenant', tenant)
            // verify required parameter 'code' is not null or undefined
            assertParamExists('updateRole', 'code', code)
...
export const RolesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRole(tenant: string, code: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RoleResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRole(tenant, code, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async updateRole(tenant: string, code: string, updateRoleRequest: UpdateRoleRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateRole(tenant, code, updateRoleRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const RolesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRole(tenant: string, code: string, options?: RawAxiosRequestConfig): AxiosPromise<RoleResult> {
         ...
         * @throws {RequiredError}
         */
        updateRole(tenant: string, code: string, updateRoleRequest: UpdateRoleRequest, options?: RawAxiosRequestConfig): AxiosPromise<object> {
            return localVarFp.updateRole(tenant, code, updateRoleRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class RolesApi extends BaseAPI {
     ...
     * @memberof RolesApi
     */
    public getRole(tenant: string, code: string, options?: RawAxiosRequestConfig) {
        return RolesApiFp(this.configuration).getRole(tenant, code, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RolesApi
     */
    public updateRole(tenant: string, code: string, updateRoleRequest: UpdateRoleRequest, options?: RawAxiosRequestConfig) {
        return RolesApiFp(this.configuration).updateRole(tenant, code, updateRoleRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
