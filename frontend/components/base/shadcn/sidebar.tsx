...
// `brand` remaps the semantic sidebar tokens onto their brand counterparts
// (see the `sidebar-brand` utility in themes/tailwind.base.css).
...
function Sidebar({
  ...
  return (
    <div
      className={cn('group peer hidden text-sidebar-foreground md:block', sidebarVariants({ brand }))}
      data-state={state}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground hover:cursor-pointer',
        size === 'sm' && 'text-xs',
        size === 'md' && 'text-sm',
        'group-data-[collapsible=icon]:hidden',
        className,
