...
/**
 *
 * @TODO: Te be remove when QueryBuilder V3 is online. This node use the old update query function
 * @deprecated
 ...
 */
function DepreciatedGeneCell({ className, symbol }: GeneCellProps) {
...
export default DepreciatedGeneCell;
