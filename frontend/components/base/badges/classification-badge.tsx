...
export const ClassificationValueMap: Record<string, BadgeProps['variant']> = {
  ...
  likely_pathogenic_low_penetrance: 'orange',
  ...
  oncogenic: 'red',
  pathogenic: 'red',
  pathogenic_low_penetrance: 'orange',
  protective: 'neutral',
  conflicting_classifications_of_pathogenicity: 'orange',
  conflicting_data_from_submitters: 'neutral',
  conflicting_interpretations_of_pathogenicity: 'yellow',
  no_classification_for_the_single_variant: 'neutral',
