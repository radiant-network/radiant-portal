...
const ElementOperatorIcon = ({ size = 16, fill = 'currentColor', ...props }: IconType): ReactElement => (
  <svg height={size} width={size} viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg" fill={fill} {...props}>
