...
export const occurrenceListApi = 'api/occurrences/germline/snv/:case_id/:seq_id/list';
export const occurrenceAggregateApi = 'api/occurrences/germline/snv/:case_id/:seq_id/aggregate';
export const occurrenceAggregateStatisticApi = 'api/occurrences/germline/snv/:case_id/:seq_id/statistics';
...
export async function httpOccurrenceListApiResponse(_query: any) {
