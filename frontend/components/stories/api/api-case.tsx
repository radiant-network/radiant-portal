...
export async function httpCaseGermlineEntityApi() {
  return HttpResponse.json({
    case_id: 1,
    case_type: 'germline_family',
    analysis_catalog_code: 'WGA',
    ...
    tasks: [
      {
        ...
        type_name: 'Genome Alignment and Germline Variant Calling',
      ...
      },
      {
        ...
        type_name: 'Family Joint Genotyping',
        created_on: '2021-10-12T13:08:00Z',
        patients: ['father', 'mother', 'proband'],
      },
      {
        id: 63,
        type_code: 'radiant_germline_annotation',
        type_name: 'RADIANT Germline Annotation',
        created_on: '2021-10-12T13:08:00Z',
        patients: ['father', 'mother', 'proband'],
      },
      {
...
export async function httpCaseSomaticEntityApi() {
  return HttpResponse.json({
    case_id: 1,
    case_type: 'somatic',
    analysis_catalog_code: 'WGA',
