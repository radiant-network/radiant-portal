  ...
  return HttpResponse.json({
    list: [
      ...
      },
      {
        case_id: 4,
        proband_id: 10,
        proband_mrn: 'MRN-283782',
        priority_code: 'routine',
        status_code: 'incomplete',
        case_analysis_code: 'IDGD',
        case_analysis_name: 'Intellectual Deficiency and Global Developmental Delay',
        case_type: 'germline_family',
        primary_condition_id: 'MONDO:0700092',
        primary_condition_name: 'neurodevelopmental disorder',
        requested_by_code: 'CHUSJ',
      ...
      },
      {
        ...
        performer_lab_name: 'Quebec Clinical Genomic Center',
        request_id: 12,
        managing_organization_code: 'UCSF',
        managing_organization_name: 'University of California San-Francisco',
        has_variants: false,
      },
      {
        case_id: 13,
        proband_id: 37,
        proband_mrn: 'MRN-283809',
        priority_code: 'routine',
        status_code: 'incomplete',
        case_analysis_code: 'WGA',
        case_analysis_name: 'Whole Genome Analysis',
      ...
      },
      {
        ...
        performer_lab_name: 'Quebec Clinical Genomic Center',
        request_id: 14,
        managing_organization_code: 'CHOP',
        managing_organization_name: 'Children Hospital of Philadelphia',
        has_variants: false,
      },
      {
        case_id: 15,
        proband_id: 42,
        proband_mrn: 'MRN-283814',
        priority_code: 'routine',
        status_code: 'draft',
        case_analysis_code: 'WGA',
        case_analysis_name: 'Whole Genome Analysis',
