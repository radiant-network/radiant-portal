...
export function getHTTPMockNotesList() {
  return HttpResponse.json([
    ...
    },
    {
      ...
      occurrence_id: 1,
      user_id: '2',
      user_name: 'Jeanne Tremblay',
      created_at: '2025-02-25T19:29:21.079151Z',
      updated_at: '2025-02-25T19:29:21.079151Z',
      content:
