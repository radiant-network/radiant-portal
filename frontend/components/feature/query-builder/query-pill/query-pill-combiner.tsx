      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            onClick={() => query.changeCombineOperator(isAndOperator ? BooleanOperators.Or : BooleanOperators.And)}
          >
        ...
        <TooltipContent>
          ...
          {isAndOperator ? dict.queryPill.operator.or : dict.queryPill.operator.and}"
        </TooltipContent>
      </Tooltip>
    </div>
  );
