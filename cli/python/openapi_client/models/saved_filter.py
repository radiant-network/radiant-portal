...
class SavedFilter(BaseModel):
    ...
    user_id: StrictStr
    __properties: ClassVar[List[str]] = ["created_on", "favorite", "id", "name", "queries", "type", "updated_on", "user_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "queries": [Sqon.from_dict(_item) for _item in obj["queries"]] if obj.get("queries") is not None else None,
            "type": obj.get("type"),
