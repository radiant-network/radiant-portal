...
class PubmedCitation(BaseModel):
    ...
    nlm: Optional[PubmedCitationDetails] = None
    __properties: ClassVar[List[str]] = ["id", "nlm"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of nlm
        if self.nlm:
            _dict['nlm'] = self.nlm.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "nlm": PubmedCitationDetails.from_dict(obj["nlm"]) if obj.get("nlm") is not None else None
        })
        return _obj
