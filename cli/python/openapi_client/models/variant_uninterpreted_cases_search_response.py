...
class VariantUninterpretedCasesSearchResponse(BaseModel):
    """
    VariantUninterpretedCasesSearchResponse
    """ # noqa: E501
    count: StrictInt
    list: List[VariantUninterpretedCase]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "list": [VariantUninterpretedCase.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
