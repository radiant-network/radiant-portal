...
*CaseGroupsApi* | [**notify_case_group**](docs/CaseGroupsApi.md#notify_case_group) | **POST** /{tenant}/case_groups/{name}/notify | Email the diagnosis laboratories of a case group
...
## Documentation For Models
 ...
 - [CaseGroupEmailContext](docs/CaseGroupEmailContext.md)
 - [CaseGroupEmailReport](docs/CaseGroupEmailReport.md)
