...
class ListBodyWithSqon(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["additional_fields", "limit", "offset", "page_index", "sort", "sqon", "with_flag", "with_interpretation", "with_note"]
