...
class CreateSampleBatchBody(BaseModel):
    """
    CreateSampleBatchBody represents the body required to create a sample batch
    """ # noqa: E501
    samples: Annotated[List[SampleBatch], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "samples": [SampleBatch.from_dict(_item) for _item in obj["samples"]] if obj.get("samples") is not None else None
        })
        return _obj
