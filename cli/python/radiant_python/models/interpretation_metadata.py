...
class InterpretationMetadata(BaseModel):
    ...
    """ # noqa: E501
    analysis_id: Optional[StrictStr] = None
    patient_id: Optional[StrictStr] = None
    variant_hash: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["analysis_id", "patient_id", "variant_hash"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "variant_hash": obj.get("variant_hash")
        })
        return _obj
