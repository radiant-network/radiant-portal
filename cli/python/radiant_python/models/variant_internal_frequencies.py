...
class VariantInternalFrequencies(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in split_rows (list)
        _items = []
        if self.split_rows:
            for _item_split_rows in self.split_rows:
                if _item_split_rows:
