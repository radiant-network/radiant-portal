...
class BeaconResponseSummary(BaseModel):
    """
    BeaconResponseSummary
    """ # noqa: E501
    exists: Optional[StrictBool] = None
    num_total_results: Optional[StrictInt] = Field(default=None, alias="numTotalResults")
    __properties: ClassVar[List[str]] = ["exists", "numTotalResults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "numTotalResults": obj.get("numTotalResults")
        })
        return _obj
