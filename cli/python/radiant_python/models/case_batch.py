...
class CaseBatch(BaseModel):
    ...
    sequencing_requests: Optional[List[CaseSequencingRequestBatch]] = Field(default=None, description="Optional. Sequencing services ordered for this case's members, delivered or not.")
