...
class CaseFamilyHistory(BaseModel):
    """
    A condition reported in a member's family, and who it was reported for
    """ # noqa: E501
    condition: StrictStr
    family_member_code: StrictStr
    __properties: ClassVar[List[str]] = ["condition", "family_member_code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "family_member_code": obj.get("family_member_code")
        })
        return _obj
