...
class BeaconFilteringTerms(BaseModel):
    ...
    filtering_terms: Optional[List[Dict[str, Any]]] = Field(default=None, alias="filteringTerms")
    resources: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["$schema", "filteringTerms", "resources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filteringTerms": obj.get("filteringTerms"),
