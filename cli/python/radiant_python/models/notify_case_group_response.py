...
class NotifyCaseGroupResponse(BaseModel):
    """
    Report of a case group notification: the group and one entry per diagnosis laboratory.
    """ # noqa: E501
    emails: List[CaseGroupEmailReport]
    group: CaseGroupResponse
    __properties: ClassVar[List[str]] = ["emails", "group"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emails": [CaseGroupEmailReport.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None,
            "group": CaseGroupResponse.from_dict(obj["group"]) if obj.get("group") is not None else None
        })
        return _obj
