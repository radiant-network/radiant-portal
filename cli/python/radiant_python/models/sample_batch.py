...
class SampleBatch(BaseModel):
    ...
    SampleBatch
    """ # noqa: E501
    fetus_id: Optional[StrictInt] = Field(default=None, description="Not mutually exclusive with the patient: the sample is drawn from the mother (SubmitterPatientId) but its sequencing data is the fetus's genome.")
