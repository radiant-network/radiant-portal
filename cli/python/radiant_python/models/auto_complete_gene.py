...
class AutoCompleteGene(BaseModel):
    """
    AutoCompleteGene
    """ # noqa: E501
    highlight: Optional[Term] = None
    source: Optional[Term] = None
    __properties: ClassVar[List[str]] = ["highlight", "source"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "highlight": Term.from_dict(obj["highlight"]) if obj.get("highlight") is not None else None,
            "source": Term.from_dict(obj["source"]) if obj.get("source") is not None else None
        })
        return _obj
