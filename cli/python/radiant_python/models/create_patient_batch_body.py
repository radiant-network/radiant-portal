...
class CreatePatientBatchBody(BaseModel):
    """
    CreatePatientBatchBody represents the body required to create a patient batch
    """ # noqa: E501
    patients: Annotated[List[PatientBatch], Field(min_length=1)]
    __properties: ClassVar[List[str]] = ["patients"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patients": [PatientBatch.from_dict(_item) for _item in obj["patients"]] if obj.get("patients") is not None else None
        })
        return _obj
