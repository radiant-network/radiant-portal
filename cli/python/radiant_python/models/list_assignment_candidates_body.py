...
class ListAssignmentCandidatesBody(BaseModel):
    """
    ListAssignmentCandidatesBody
    """ # noqa: E501
    case_ids: Optional[List[StrictInt]] = None
    limit: Optional[StrictInt] = None
    offset: Optional[StrictInt] = None
    page_index: Optional[StrictInt] = None
    search: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["case_ids", "limit", "offset", "page_index", "search"]
