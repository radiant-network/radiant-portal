...
class UpdateCaseBatchBody(BaseModel):
    """
    UpdateCaseBatchBody
    """ # noqa: E501
    cases: Annotated[List[UpdateCaseBatch], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cases": [UpdateCaseBatch.from_dict(_item) for _item in obj["cases"]] if obj.get("cases") is not None else None
        })
        return _obj
