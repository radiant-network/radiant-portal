...
class VariantInterpretedCasesSearchResponse(BaseModel):
    """
    VariantInterpretedCasesSearchResponse
    """ # noqa: E501
    count: StrictInt
    list: List[VariantInterpretedCase]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "list": [VariantInterpretedCase.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
