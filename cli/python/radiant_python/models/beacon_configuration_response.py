...
class BeaconConfigurationResponse(BaseModel):
    """
    BeaconConfigurationResponse
    """ # noqa: E501
    meta: Optional[BeaconMeta] = None
    response: Optional[BeaconConfiguration] = None
    __properties: ClassVar[List[str]] = ["meta", "response"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": BeaconConfiguration.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
