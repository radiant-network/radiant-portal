...
class SamplesApi:
    ...
    def _post_sample_batch_serialize(
        ...
        if create_sample_batch_body is not None:
            _body_params = create_sample_batch_body
    ...
    @validate_call
    def put_sample_batch(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        create_sample_batch_body: Annotated[CreateSampleBatchBody, Field(description="Update Body")],
        dry_run: Annotated[Optional[StrictBool], Field(description="Dry Run")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param tenant: Tenant code (required)
        :type tenant: str
        :param create_sample_batch_body: Update Body (required)
        :type create_sample_batch_body: CreateSampleBatchBody
        :param dry_run: Dry Run
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._put_sample_batch_serialize(
            tenant=tenant,
            create_sample_batch_body=create_sample_batch_body,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def put_sample_batch_with_http_info(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        create_sample_batch_body: Annotated[CreateSampleBatchBody, Field(description="Update Body")],
        dry_run: Annotated[Optional[StrictBool], Field(description="Dry Run")] = None,
    ...
    @validate_call
    def put_sample_batch_without_preload_content(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        create_sample_batch_body: Annotated[CreateSampleBatchBody, Field(description="Update Body")],
        dry_run: Annotated[Optional[StrictBool], Field(description="Dry Run")] = None,
    ...
    def _put_sample_batch_serialize(
        self,
        tenant,
        create_sample_batch_body,
        dry_run,
