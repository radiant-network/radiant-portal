...
class RolesApi:
    ...
    def update_role(
        ...
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        code: Annotated[StrictStr, Field(description="Role code")],
        update_role_request: Annotated[UpdateRoleRequest, Field(description="Desired state of the role")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param code: Role code (required)
        :type code: str
        :param update_role_request: Desired state of the role (required)
