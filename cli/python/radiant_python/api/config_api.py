...
class ConfigApi:
    ...
    def get_client_config(
        ...
        _param = self._get_client_config_serialize(
    ...
    @validate_call
    def get_client_config_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_client_config_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_client_config_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
