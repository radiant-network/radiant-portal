...
class AssaysApi:
    ...
    def get_assay_by_seq_id(
        ...
        _param = self._get_assay_by_seq_id_serialize(
            seq_id=seq_id,
    ...
    @validate_call
    def get_assay_by_seq_id_with_http_info(
        self,
        seq_id: Annotated[StrictStr, Field(description="Seq ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_assay_by_seq_id_without_preload_content(
        self,
        seq_id: Annotated[StrictStr, Field(description="Seq ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_assay_by_seq_id_serialize(
        self,
        seq_id,
        _request_auth,
        _content_type,
