...
class SequencingApi:
    ...
    @validate_call
    def put_sequencing_experiment_batch(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        create_sequencing_experiment_batch_body: Annotated[CreateSequencingExperimentBatchBody, Field(description="Update Body")],
        dry_run: Annotated[Optional[StrictBool], Field(description="Dry Run")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param tenant: Tenant code (required)
        :type tenant: str
        :param create_sequencing_experiment_batch_body: Update Body (required)
        :type create_sequencing_experiment_batch_body: CreateSequencingExperimentBatchBody
        :param dry_run: Dry Run
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._put_sequencing_experiment_batch_serialize(
            tenant=tenant,
            create_sequencing_experiment_batch_body=create_sequencing_experiment_batch_body,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def put_sequencing_experiment_batch_with_http_info(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        create_sequencing_experiment_batch_body: Annotated[CreateSequencingExperimentBatchBody, Field(description="Update Body")],
        dry_run: Annotated[Optional[StrictBool], Field(description="Dry Run")] = None,
    ...
    @validate_call
    def put_sequencing_experiment_batch_without_preload_content(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        create_sequencing_experiment_batch_body: Annotated[CreateSequencingExperimentBatchBody, Field(description="Update Body")],
        dry_run: Annotated[Optional[StrictBool], Field(description="Dry Run")] = None,
    ...
    def _put_sequencing_experiment_batch_serialize(
        self,
        tenant,
        create_sequencing_experiment_batch_body,
        dry_run,
