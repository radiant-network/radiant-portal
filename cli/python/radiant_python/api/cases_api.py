...
class CasesApi:
    ...
    def patch_case_status(
        ...
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        case_id: Annotated[StrictInt, Field(description="Case ID")],
        update_case_status_input: Annotated[UpdateCaseStatusInput, Field(description="Status to apply")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param case_id: Case ID (required)
        :type case_id: int
        :param update_case_status_input: Status to apply (required)
        :type update_case_status_input: UpdateCaseStatusInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_case_status_serialize(
            tenant=tenant,
            case_id=case_id,
            update_case_status_input=update_case_status_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_case_status_with_http_info(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        case_id: Annotated[StrictInt, Field(description="Case ID")],
        update_case_status_input: Annotated[UpdateCaseStatusInput, Field(description="Status to apply")],
    ...
    @validate_call
    def patch_case_status_without_preload_content(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        case_id: Annotated[StrictInt, Field(description="Case ID")],
        update_case_status_input: Annotated[UpdateCaseStatusInput, Field(description="Status to apply")],
    ...
    def _patch_case_status_serialize(
        self,
        tenant,
        case_id,
        update_case_status_input,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_case_status_input is not None:
            _body_params = update_case_status_input
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/{tenant}/cases/{case_id}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
