...
class CasesApi:
    ...
    @validate_call
    def patch_case_without_preload_content(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        case_id: Annotated[StrictInt, Field(description="Case ID")],
        patch_case: Annotated[PatchCase, Field(description="Fields to change")],
    ...
    @validate_call
    def put_case_assignments(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        case_id: Annotated[StrictInt, Field(description="Case ID")],
        update_case_assignments_request: Annotated[UpdateCaseAssignmentsRequest, Field(description="Assignees to set")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param case_id: Case ID (required)
        :type case_id: int
        :param update_case_assignments_request: Assignees to set (required)
        :type update_case_assignments_request: UpdateCaseAssignmentsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_case_assignments_serialize(
            tenant=tenant,
            case_id=case_id,
            update_case_assignments_request=update_case_assignments_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def put_case_assignments_with_http_info(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        case_id: Annotated[StrictInt, Field(description="Case ID")],
        update_case_assignments_request: Annotated[UpdateCaseAssignmentsRequest, Field(description="Assignees to set")],
    ...
    @validate_call
    def put_case_assignments_without_preload_content(
        self,
        tenant: Annotated[StrictStr, Field(description="Tenant code")],
        case_id: Annotated[StrictInt, Field(description="Case ID")],
        update_case_assignments_request: Annotated[UpdateCaseAssignmentsRequest, Field(description="Assignees to set")],
    ...
    def _put_case_assignments_serialize(
        self,
        tenant,
        case_id,
        update_case_assignments_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_case_assignments_request is not None:
            _body_params = update_case_assignments_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/{tenant}/cases/{case_id}/assignments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
