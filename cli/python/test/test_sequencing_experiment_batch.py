...
class TestSequencingExperimentBatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SequencingExperimentBatch:
        """Test SequencingExperimentBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SequencingExperimentBatch`
        """
        model = SequencingExperimentBatch()
        if include_optional:
    ...
    def testSequencingExperimentBatch(self):
        """Test SequencingExperimentBatch"""
