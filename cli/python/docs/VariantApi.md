...
------------- | ------------- | -------------
[**get_germline_variant_cases_count**](VariantApi.md#get_germline_variant_cases_count) | **GET** /{tenant}/variants/germline/{locus_id}/cases/count | Get germline cases count for a given locus
[**get_germline_variant_cases_filters**](VariantApi.md#get_germline_variant_cases_filters) | **GET** /{tenant}/variants/germline/cases/filters | Get cases filters for germline variant entity
[**get_germline_variant_conditions**](VariantApi.md#get_germline_variant_conditions) | **GET** /{tenant}/variants/germline/{locus_id}/conditions/{panel_type} | Get conditions for germline variant entity for a specific gene panel
[**get_germline_variant_conditions_clinvar**](VariantApi.md#get_germline_variant_conditions_clinvar) | **GET** /{tenant}/variants/germline/{locus_id}/conditions/clinvar | Get ClinVar conditions for germline variant entity
[**get_germline_variant_consequences**](VariantApi.md#get_germline_variant_consequences) | **GET** /{tenant}/variants/germline/{locus_id}/consequences | Get list of VariantConsequences for a germline variant
[**get_germline_variant_external_frequencies**](VariantApi.md#get_germline_variant_external_frequencies) | **GET** /{tenant}/variants/germline/{locus_id}/external_frequencies | Get external frequencies
[**get_germline_variant_global_internal_frequencies**](VariantApi.md#get_germline_variant_global_internal_frequencies) | **GET** /{tenant}/variants/germline/{locus_id}/internal_frequencies/global | Get global internal frequencies
[**get_germline_variant_header**](VariantApi.md#get_germline_variant_header) | **GET** /{tenant}/variants/germline/{locus_id}/header | Get a germline VariantHeader
[**get_germline_variant_internal_frequencies**](VariantApi.md#get_germline_variant_internal_frequencies) | **GET** /{tenant}/variants/germline/{locus_id}/internal_frequencies | Get internal frequencies
[**get_germline_variant_interpreted_cases**](VariantApi.md#get_germline_variant_interpreted_cases) | **POST** /{tenant}/variants/germline/{locus_id}/cases/interpreted | Get list of interpreted Cases for a germline variant
[**get_germline_variant_overview**](VariantApi.md#get_germline_variant_overview) | **GET** /{tenant}/variants/germline/{locus_id}/overview | Get a germline VariantOverview
[**get_germline_variant_uninterpreted_cases**](VariantApi.md#get_germline_variant_uninterpreted_cases) | **POST** /{tenant}/variants/germline/{locus_id}/cases/uninterpreted | Get list of uninterpreted Cases for a germline variant


# **get_germline_variant_cases_count**
> VariantCasesCount get_germline_variant_cases_count(tenant, locus_id)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get germline cases count for a given locus
        api_response = api_instance.get_germline_variant_cases_count(tenant, locus_id)
...
> VariantCasesFilters get_germline_variant_cases_filters(tenant)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get cases filters for germline variant entity
        api_response = api_instance.get_germline_variant_cases_filters(tenant)
...
> GenePanelConditions get_germline_variant_conditions(tenant, locus_id, panel_type, filter=filter)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get conditions for germline variant entity for a specific gene panel
        api_response = api_instance.get_germline_variant_conditions(tenant, locus_id, panel_type, filter=filter)
...
> ClinvarVariantConditions get_germline_variant_conditions_clinvar(tenant, locus_id)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get ClinVar conditions for germline variant entity
        api_response = api_instance.get_germline_variant_conditions_clinvar(tenant, locus_id)
...
> List[VariantConsequence] get_germline_variant_consequences(tenant, locus_id)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get list of VariantConsequences for a germline variant
        api_response = api_instance.get_germline_variant_consequences(tenant, locus_id)
...
> VariantExternalFrequencies get_germline_variant_external_frequencies(tenant, locus_id)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get external frequencies
        api_response = api_instance.get_germline_variant_external_frequencies(tenant, locus_id)
...
# **get_germline_variant_global_internal_frequencies**
> InternalFrequencies get_germline_variant_global_internal_frequencies(tenant, locus_id)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get global internal frequencies
        api_response = api_instance.get_germline_variant_global_internal_frequencies(tenant, locus_id)
        print("The response of VariantApi->get_germline_variant_global_internal_frequencies:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VariantApi->get_germline_variant_global_internal_frequencies: %s\n" % e)
```
...
[**InternalFrequencies**](InternalFrequencies.md)
...
> VariantHeader get_germline_variant_header(tenant, locus_id)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a germline VariantHeader
        api_response = api_instance.get_germline_variant_header(tenant, locus_id)
...
> VariantInternalFrequencies get_germline_variant_internal_frequencies(tenant, locus_id, split)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get internal frequencies
        api_response = api_instance.get_germline_variant_internal_frequencies(tenant, locus_id, split)
...
> VariantInterpretedCasesSearchResponse get_germline_variant_interpreted_cases(tenant, locus_id, list_body_with_criteria)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get list of interpreted Cases for a germline variant
        api_response = api_instance.get_germline_variant_interpreted_cases(tenant, locus_id, list_body_with_criteria)
...
> VariantOverview get_germline_variant_overview(tenant, locus_id)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a germline VariantOverview
        api_response = api_instance.get_germline_variant_overview(tenant, locus_id)
...
> VariantUninterpretedCasesSearchResponse get_germline_variant_uninterpreted_cases(tenant, locus_id, list_body_with_criteria)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get list of uninterpreted Cases for a germline variant
        api_response = api_instance.get_germline_variant_uninterpreted_cases(tenant, locus_id, list_body_with_criteria)
