...
[**get_germline_variant_global_internal_frequencies**](VariantApi.md#get_germline_variant_global_internal_frequencies) | **GET** /variants/germline/{locus_id}/internal_frequencies/global | Get global internal frequencies
...
> InternalFrequencies get_germline_variant_global_internal_frequencies(locus_id)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get global internal frequencies
        api_response = api_instance.get_germline_variant_global_internal_frequencies(locus_id)
