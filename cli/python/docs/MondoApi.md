# radiant_python.MondoApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**mondo_term_auto_complete**](MondoApi.md#mondo_term_auto_complete) | **GET** /{tenant}/mondo/autocomplete | Get AutoCompleteTerm list of matching input string with highlighted


# **mondo_term_auto_complete**
> List[AutoCompleteTerm] mondo_term_auto_complete(tenant, prefix, limit=limit)
...
with radiant_python.ApiClient(configuration) as api_client:
    ...
    api_instance = radiant_python.MondoApi(api_client)
    ...
    try:
        # Get AutoCompleteTerm list of matching input string with highlighted
        api_response = api_instance.mondo_term_auto_complete(tenant, prefix, limit=limit)
        print("The response of MondoApi->mondo_term_auto_complete:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MondoApi->mondo_term_auto_complete: %s\n" % e)
```
