...
export const tableSomaticFacets = [
  ...
  },
  {
    ...
    facets: [
      {
        id: 'somatic_to_freq',
        name: 'Freq. TO All Patients',
        apiField: 'somatic_pf_to_wgs',
        position: 0,
        tooltip: 'Frequency across all patients of the network who had a tumor-only analysis (WGS)',
        defaultOperator: '<',
        hasDictionary: false,
      },
      {
