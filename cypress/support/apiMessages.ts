export const apiMessages = {
  ...
  ProcessWorkerErrorOneOfTypeCode: (type: string, field: string, code: string, id: string, value: string) => `Invalid field ${field} for ${type} (${code} / ${id}). Reason: \"${value}\" is not a valid type code. Valid values [blood, buffy_coat, dna, not_reported, rna, saliva, solid_tissue].`,
