export const apiMessages = {
  ...
  ProcessWorkerError001: (type: string, code: string, id: string) => `${type} (${code} / ${id}) already exist, skipped.`,
  ...
  ProcessWorkerErrorNotSamePatient: (type: string, field: string, code: string, id: string) => `Invalid field ${field} for ${type} (${code} / ${id}). Reason: TODO.`,
