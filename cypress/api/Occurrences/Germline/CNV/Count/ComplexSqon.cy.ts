...
describe('Occurrences - Germline - CNV - Count - Complex SQON', () => {
  let response: any;
  let Auth: any;
  let case_id: string;
  let seq_id: string;
  ...
  it('Two pills combined with AND', () => {
    const complexData = globalData.Count.cnv.Complex.twoPillsAnd;
  ...
  it('Two pills combined with OR', () => {
    const complexData = globalData.Count.cnv.Complex.twoPillsOr;
  ...
  it('Pill with the not-in operator', () => {
    const complexData = globalData.Count.cnv.Complex.notIn;
  ...
  it('Two queries combined with OR', () => {
    const complexData = globalData.Count.cnv.Complex.combined;
