...
describe('Occurrences - Germline - SNV - Count - Complex SQON', () => {
  let response: any;
  let Auth: any;
  let case_id: string;
  let seq_id: string;
  ...
  it('Two pills combined with AND', () => {
    const complexData = globalData.Count.snv.Complex.twoPillsAnd;
  ...
  it('Two pills combined with OR', () => {
    const complexData = globalData.Count.snv.Complex.twoPillsOr;
  ...
  it('Pill with the not-in operator', () => {
    const complexData = globalData.Count.snv.Complex.notIn;
  ...
  it('Two queries combined with OR', () => {
    const complexData = globalData.Count.snv.Complex.combined;
