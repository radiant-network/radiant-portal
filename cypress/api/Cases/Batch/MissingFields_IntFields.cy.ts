...
describe('Cases - Batch - Missing fields - Int fields', () => {
  let response: any;
  ...
  it('Message', () => {
    cy.validateMessage(response, apiMessages.ImmediateError('CreateCaseBatchBody.Cases[0].Tasks[0].OutputDocuments[0]', 'Size', 'required'));
  });
});
