...
describe('Sequencing - Batch - Process worker - Seq002', () => {
  ...
  it('Validate report sequencing_experiment[0] status_code', () => {
    cy.validateReport(response, 'error', 'SEQ-002', apiMessages.ProcessWorkerErrorOneOfStatutCode('sequencing_experiment', 'status_code', 'CQGC', 'S13224', '1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890!', 'Cypress'), 'sequencing_experiment[0].status_code');
  });
});