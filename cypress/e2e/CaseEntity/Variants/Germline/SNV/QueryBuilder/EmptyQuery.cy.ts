...
describe('Case Entity - Variants - Germline - SNV - Query builder - Empty query', () => {
  const setupTest = () => {
    cy.login();
  ...
  it('Build a first pill', () => {
    setupTest();
    CaseEntity_Variants_QueryBuilder.snv.actions.buildFirstPill();
    ...
    CaseEntity_Variants_QueryBuilder.snv.validations.shouldHaveQueryCount();
  ...
  it('Collapse and expand the query panel', () => {
    setupTest();
    CaseEntity_Variants_QueryBuilder.snv.validations.shouldBeCollapsed(false /*collapsed*/);

    CaseEntity_Variants_QueryBuilder.snv.actions.toggleCollapse();
    CaseEntity_Variants_QueryBuilder.snv.validations.shouldBeCollapsed(true /*collapsed*/);
