...
exports.billingContactHistoryGet = void 0;
const ClientSdk_1 = require("../../../ClientSdk");
const getResponse_1 = require("../../actions/getResponse");
const Routes_1 = require("../../routes/Routes");
const billingContactHistoryGet = (queryParams) => {
    var _a, _b;
    const config = {
        method: 'get',
        url: `${(_a = queryParams === null || queryParams === void 0 ? void 0 : queryParams.url) !== null && _a !== void 0 ? _a : (0, Routes_1.BillingContactRoute)()}${(queryParams === null || queryParams === void 0 ? void 0 : queryParams.id) ? `/${queryParams === null || queryParams === void 0 ? void 0 : queryParams.id}` : ''}`,
...
exports.billingContactHistoryGet = billingContactHistoryGet;
//# sourceMappingURL=billingContactHistoryService.js.map